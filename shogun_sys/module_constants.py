...
slot_player_food_tick                  = 59 # food tick number RAMARAUNT

slot_player_drunkeness                 = 60 # drunkeness RAMARAUNT ADD
slot_player_trippiness                 = 61 # trippiness RAMARAUNT ADD
slot_player_cold_progression           = 62 # RAMARAUNT ADD
slot_player_cold_direction             = 63 # RAMARAUNT ADD
slot_player_cold_immunity_timer        = 64 #Ramaraunt Add
slot_player_flu_progression            = 65 # RAMARAUNT ADD
slot_player_flu_direction              = 66 # RAMARAUNT ADD
slot_player_flu_immunity_timer         = 67 #Ramaraunt Add
slot_player_plague_progression         = 68 # RAMARAUNT ADD
slot_player_plague_direction           = 69 # RAMARAUNT ADD
slot_player_plague_immunity_timer      = 70 #Ramaraunt Add

slot_player_zombie_infected            = 71 #Ramaraunt ADD
slot_player_zombie_necromancer		   = 72 #ramaraunt ADD

slot_player_necromancer_zombie_state   = 73 #current state of the necromancer's zombie horde. -4 = peaceful. -3 = faction friendly. -2 = faction allies friendly. -1 = all enemy. Anything else is a player id that is currently targeted.
necro_state_begin      = -6
necro_state_peaceful   = -6
necro_state_allies_com_outlaw = -5
necro_state_allies_com = -4
necro_state_allies     = -3
necro_state_faction    = -2
necro_state_noone      = -1
necro_state_ffa        = 0
necro_state_end        = 0
########################################################
...
slot_agent_necromancer                = 67 #Ramaraunt add for undead leader/summoner leader
...
slot_money_chest_interest_timer        = 102 #Ramaraunt add
...
slot_item_necronominon_page           = 29 #RAMARAUNT ADD
...
slot_mission_data_interest_box_begin            = 50 #RAMARAUNT ADD
slot_mission_data_interest_box_end              = 58 #RAMARAUNT ADD
...
max_distance_to_catch_cough           = 1500 #Ramaraunt Add
...
lockpicking_fail_color                = 0xFF0000FF #Ramaraunt add
lockpicking_success_color             = 0x32CD32FF #Ramaraunt add
...
zombie_max_count = 50 #ramaraunt add
golem_max_count = 20 #ramaraunt add
