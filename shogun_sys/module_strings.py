...
# Strings before this point are hardwired.
  ("credits_0", "Persistent World Module^Copyright 2010 Steven Schwartfeger (Vornne)^ShogunRP Module^ Copyright 2017 Daniel Valcour (Ramaraunt)"),
  ("credits_1", "Mount&Blade: Warband Copyright 2008-2016 Taleworlds Entertainment"),
...
"),
  ...
  ("process_rice", "Prepare"),#Ramaraunt add
  ("process_milk", "Milk Cow"), #Ramaraunt add
  ("process_butter", "Churn"), #Ramaraunt add
  ("process_spin", "Spin"),
  ("process_weave", "Weave"),
  ("process_cut", "Cut"),
...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("scene_name_11", "Jhorgee's Valley"), #Ramaraunt Add
  ...
  ("castle_name_67", "Temple of Xen"),
  ("castle_name_68", "Mazuhenga"),
  ("castle_name_69", "Chinesse Chicken Land"),
  ("castle_name_70", "Kayata"),
  ("castle_name_71", "Akashi Palace"),
  ("castle_name_72", "Hachigata"),
  ("castle_name_73", "Iga Ueno"),
  ("castle_name_74", "Igena"),
  ("castle_name_75", "Iwaurma"),
  ("castle_name_76", "Ito"),
  ("castle_name_77", "Miyao"),
  ("castle_name_78", "Ne"),
  ("castle_name_79", "Otaki"),
  ("castle_name_80", "Sumoto"),

  
  ("castle_name_81", "Welcome to ShogunRP! Please go to legionrp.boards.net for rules."),
  
  ("castle_name_82", "Hiroshi's Tavern"),
  ("castle_name_83", "Necromancer's Lair"),
  ("castle_name_84", "The Dark Tower"),
  
  ("castle_names_end", "Invalid Castle Name"),
  
  #Ramaraunt add
  ("interest_ledger_string", "Ledger for {s11}:^You need to have at least {reg45} coins^ in the chest in order to recieve tax money.^^ If you have this much, you will gain tax money from people who^ buy and sell items from the faction, and you will recieve^ {reg46} coins every 10 minutes. ^^ The last faction member to use the money chest was: '{s49}'."),
  ("ledger", "Ledger"),
  ("noone", "Noone"),
  
  ("drop_twenty", "Drop twenty percent"),
  ("drops_twenty_percent", "{s15} has dropped 20% of his/her gold!"),
  ("has_no_gold", "{s15} has no gold to drop!"),
  
  ("pick_fail", "You failed to pick the lock."),
  ("pick_success", "You successfully pick the lock."),
  
  
  ("drink_swig", "You drink a swig of the beverage."),
  ("drink_sober", "You feel sober again."),
  ("drink_fine", "You feel fine."),
  ("drink_tipsy", "You feel slightly tipsy."),
  ("drink_wobbly", "You feel a bit wobbly."),
  ("drink_sick", "You feel sick."),
  ("drink_dazed", "You feel extremely dazed and out of sorts."),
  
  ("you_vomit", "You have vomitted!"),
  ("he_vomit", "{s1} has vomitted!"),
  
  ("you_cough", "You cough!"),
  ("he_cough", "{s1} has coughed!"),
  
  #illness
  ("slightly_sick", "You notice that you have a scratchy throat!"),
  ("flu_begin", "You notice that you have a scratchy throat and feel achy all over!"),
  ("flu_ache", "Your stomach aches with pain!"),
  ("flu_better_stomach", "Your stomach feels better, but the sore throat remains"),
  ("flu_pain", "You are full of pain agony from your sickness!"),
  ("flu_almost_gone", "You feel that your sickness has almost left you!"),
  ("flu_gone", "You feel alive and refreshed!"),
  ("very_sick", "You notice that you feel very sick!"),
  ("starting_to_feel_better", "You notice that you are starting to feel better, but you are still sick."),
  ("not_sick_anymore", "You notice that you don't feel sick anymore."),
  ("plague_slight_rash", "You notice that you itch all over, and you have a scratchy throat."),
  ("plague_vomiting", "Your stomach feels like it is about to explode! Massive black warts have formed all over your body."),
  ("plague_agony", "You are in terrible agony. You wish you would just die already."),
  ("plague_turning_around", "Your illness seems to be retreating!"),
  ("plague_stomach_better", "Your stomach feels much better, though your sore throat remains."),
  ("plague_cured", "You have survived the plague. The gods are with you, surely."),
  ("global_ck_plague", "{s0} has died of the plague!"),
  ("item_plague_mask", "This mask will make you immune to other players coughing if you are a physician!"),
  
  ("log_player_caught_cold", "{s0} has caught a cold."),
  ("log_player_lost_cold", "{s0} has lost a cold."),
  ("log_player_caught_flu", "{s0} has caught the flu."),
  ("log_player_lost_flu", "{s0} has lost the flu."),
  ("log_player_caught_plague", "{s0} has caught the plague."),
  ("log_player_lost_plague", "{s0} has lost the plague."),
  
  ("necro_book", "NECRONOMINOMICON^^ HELLO WORTHY! YOU CAN READ THE BOOK OF LIFE AND DEATH! STAB TO FLIP PAGES! UPPERHAND SWING ON THE FIRST PAGE TO READ THIS BOOK AGAIN! UPPERHAND SWING ON THE SECOND PAGE TO SELECT A TARGET FOR YOUR MINIONS TO KILL! ONE PAGE ONE, LEFT HAND TO SPAWN A MINION! RIGHT SWING TO SPAWN A SKELETON HORSE! ON THE SECOND PAGE, LEFT SWING TO KILL ALL OF YOUR OWN UNDEAD! RIGHT SWING TO CHANGE YOUR HORDE'S STATE! ^^THE POWER OF LIFE AND DEATH IS IN YOUR HANDS!"),
  
  ("necro_book_page_turned_one", "You have flipped to the first page!"),
  ("necro_book_page_turned_two", "You have flipped to the second page!"),
  ("necro_state_peaceful", "Your minions will be peaceful to everyone!"),
  ("necro_state_faction", "Your minions will only be peaceful to people in your faction!"),
  ("necro_state_allies", "Your minions will be peaceful to people in your faction and allied factions!"),
  ("necro_state_allies_commoner", "Your minions will be peaceful to people in your faction, allied factions, and commoner faction!"),
  ("necro_state_allies_commoner_outlaw", "Your minions will be peaceful to people in your faction, allied factions, commoner faction, and outlaws faction!"),
  ("necro_state_noone", "Your minions will kill everyone besides you!"),
  ("necro_state_ffa", "Your minions will fight everyone and each other, not including you!"),
