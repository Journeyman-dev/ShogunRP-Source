...
# A cow for gathering milk using buckets. #ramaraunt add
def spr_cow_triggers():
  return [(ti_on_scene_prop_use,
     [(store_trigger_param_1, ":agent_id"),
      (agent_get_wielded_item, ":wielded_item_id", ":agent_id", 0),
      (eq, ":wielded_item_id", "itm_bucket"),
      (call_script, "script_cf_agent_consume_item", ":agent_id", "itm_bucket", 1),
      (agent_equip_item, ":agent_id", "itm_milk_bucket"),
      (agent_set_wielded_item, ":agent_id", "itm_milk_bucket"),
      ])]
...
scene_props = [
  ...
  #SHOGUN MOD BEGIN - RAMARAUNT
  ("pws_buy_bamboo_lance",spr_buy_item_flags(3),"bamboo_lance","bo_pw_weapon_big", spr_buy_item_triggers("itm_bamboo_lance", resources=["itm_wood_pole", "itm_iron_piece"], engineer=2)),
  ("pws_buy_yari",spr_buy_item_flags(2),"banner_yari","bo_pw_weapon_big", spr_buy_item_triggers("itm_yari", resources=["itm_wood_pole", "itm_iron_piece", "itm_linen_cloth"], engineer=2)),
  ("pws_buy_yumi_a",spr_buy_item_flags(4),"bogmir_yumi","bo_pw_weapon", spr_buy_item_triggers("itm_yumi", resources=["itm_wood_pole"], engineer=3)),
  ("pws_buy_yumi_b",spr_buy_item_flags(4),"bogmir_yumi_final","bo_pw_weapon", spr_buy_item_triggers("itm_yumi_solid", resources=["itm_wood_pole"], engineer=3)),
  ("pws_buy_domaru_nobori",spr_buy_item_flags(17),"domaru_nobori","bo_pw_armor_body", spr_buy_item_triggers("itm_samurai_heraldic_flag_1", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], engineer=6)),
  ("pws_buy_domaru_b",spr_buy_item_flags(17),"domaru_b","bo_pw_armor_body", spr_buy_item_triggers("itm_samurai_yellow_coat", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], engineer=6)),
  ("pws_buy_domaru_plain",spr_buy_item_flags(17),"domaru_inv","bo_pw_armor_body", spr_buy_item_triggers("itm_samurai_plain", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], engineer=6)),
  ("pws_buy_yari_crossed",spr_buy_item_flags(9),"jumonji_yari","bo_pw_weapon_big", spr_buy_item_triggers("itm_yari_crossed", resources=["itm_wood_pole", "itm_iron_bar"], engineer=3)),
  ("pws_buy_kote_arms",spr_buy_item_flags(4),"kote_arms_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_kote_arms", resources=["itm_iron_piece"], engineer=3)),
  ("pws_buy_mongol_heavy_sword",spr_buy_item_flags(14),"mongol_heavy_sword","bo_pw_weapon", spr_buy_item_triggers("itm_heavy_sword", resources=["itm_iron_bar_long"], engineer=6)),
  ("pws_buy_naginata",spr_buy_item_flags(9),"naginata","bo_pw_weapon_big", spr_buy_item_triggers("itm_naginata", resources=["itm_wood_pole", "itm_iron_bar"], engineer=3)),
  ("pws_buy_naginata_light",spr_buy_item_flags(9),"naginata_light","bo_pw_weapon_big", spr_buy_item_triggers("itm_light_naginata", resources=["itm_wood_pole", "itm_iron_bar"], engineer=3)),
  ("pws_buy_sharp_arrows",spr_buy_item_flags(1),"samurai_quiver_b","bo_pw_weapon", spr_buy_item_triggers("itm_sharp_arrows", resources=[], engineer=1)),
  ("pws_buy_balanced_arrows",spr_buy_item_flags(1),"samurai_quiver_a","bo_pw_weapon", spr_buy_item_triggers("itm_balanced_arrows", resources=[], engineer=1)),
  ("pws_buy_samurai_maul",spr_buy_item_flags(2),"samurai_maul","bo_pw_weapon", spr_buy_item_triggers("itm_samurai_maul", resources=["itm_wood_pole", "itm_iron_piece"], engineer=5)),
  ("pws_buy_samurai_sword",spr_buy_item_flags(6),"samurai_sword","bo_pw_weapon", spr_buy_item_triggers("itm_samurai_sword", resources=["itm_iron_bar"], engineer=3)),
  ("pws_buy_ninja_gauntlets",spr_buy_item_flags(2),"shadow_gauntlets_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_ninja_gauntlets", resources=["itm_leather_piece"], tailoring=2, engineer=4)),
  ("pws_buy_ninja_boots_bugged",spr_buy_item_flags(6),"shadow_greaves","bo_pw_armor_foot", spr_buy_item_triggers("itm_ninja_boots", resources=["itm_leather_piece",("itm_iron_piece",2)], engineer=4)),
  ("pws_buy_ninja_mask",spr_buy_item_flags(5),"shadow_mask","bo_pw_armor_head", spr_buy_item_triggers("itm_ninja_mask", resources=["itm_leather_piece","itm_iron_piece"], engineer=2)),
  ("pws_buy_ninja_mail",spr_buy_item_flags(10),"shadow_outfit_c","bo_pw_armor_body", spr_buy_item_triggers("itm_ninja_mail", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
  ("pws_buy_shinobi",spr_buy_item_flags(8),"shinobi_bite_throw","bo_pw_weapon_small", spr_buy_item_triggers("itm_shinobi", resources=["itm_iron_piece"], engineer=4)),
  ("pws_buy_suneate",spr_buy_item_flags(4),"suneate","bo_pw_armor_foot", spr_buy_item_triggers("itm_suneate", resources=[("itm_leather_piece",2)], tailoring=3, engineer=3)),
  ("pws_buy_suneate_steel",spr_buy_item_flags(8),"suneate_steel","bo_pw_armor_foot", spr_buy_item_triggers("itm_suneate_steel", resources=["itm_leather_piece",("itm_iron_bar_short",3)], engineer=6)),
  ("pws_two_handed_katana",spr_buy_item_flags(14),"two_handed_katana","bo_pw_weapon", spr_buy_item_triggers("itm_two_handed_katana", resources=["itm_iron_bar_long"], engineer=6)),
  ("pws_buy_yari_b",spr_buy_item_flags(2),"yari_spear_b","bo_pw_weapon_big", spr_buy_item_triggers("itm_yari_spear_b", resources=["itm_wood_pole", "itm_iron_piece", "itm_linen_cloth"], engineer=2)),
  ("pws_buy_yari_crimson",spr_buy_item_flags(2),"yari_spear_crimson","bo_pw_weapon_big", spr_buy_item_triggers("itm_yari_spear_crimson", resources=["itm_wood_pole", "itm_iron_piece", "itm_linen_cloth"], engineer=2)),
  
   ("pws_buy_kabuto",spr_buy_item_flags(17),"kabuto","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_kabuto", resources=[("itm_iron_bar_short",2),"itm_leather_piece"], engineer=6)),
   ("pws_buy_yoroi_bugged",spr_buy_item_flags(17),"yoroi","bo_pw_armor_body", spr_buy_item_triggers("itm_yoroi", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], engineer=6)),
   ("pws_buy_elite_suneate",spr_buy_item_flags(10),"elite_suneate","bo_pw_armor_foot", spr_buy_item_triggers("itm_elite_suneate", resources=[("itm_leather_piece",2),("itm_iron_bar",2)], engineer=6)),
   ("pws_buy_elite_kote",spr_buy_item_flags(5),"kote_L","bo_pw_armor_hand", spr_buy_item_triggers("itm_elite_kote", resources=["itm_leather_piece","itm_iron_piece"], engineer=6)),
   
   ("pws_buy_camel",spr_buy_item_flags(2),"camel","bo_pw_horse", spr_buy_item_triggers("itm_camel", resources=["itm_board", "itm_wheat_sheaf"], herding=1)),
	
   ("pws_jungle_coat",spr_buy_item_flags(2),"ao_linh2_l","bo_pw_armor_body", spr_buy_item_triggers("itm_vietamese_coat", resources=["itm_leather_roll","itm_linen_cloth_small"], tailoring=1)),
  ("pws_buy_dojo_robe_a",spr_buy_item_flags(3),"ao_vai_1","bo_pw_armor_body", spr_buy_item_triggers("itm_dojo_robe_a", resources=["itm_linen_cloth"], tailoring=1)),
  ("pws_buy_dojo_robe_b",spr_buy_item_flags(3),"ao_vai_2","bo_pw_armor_body", spr_buy_item_triggers("itm_dojo_robe_b", resources=["itm_linen_cloth"], tailoring=1)),
  ("pws_buy_dojo_robe_c",spr_buy_item_flags(3),"ao_vai_2_l","bo_pw_armor_body", spr_buy_item_triggers("itm_dojo_robe_c", resources=["itm_linen_cloth"], tailoring=1)),
  ("pws_buy_dojo_robe_d",spr_buy_item_flags(3),"ao_vai_2_x","bo_pw_armor_body", spr_buy_item_triggers("itm_dojo_robe_d", resources=["itm_linen_cloth"], tailoring=1)),
  ("pws_buy_domaru_brown",spr_buy_item_flags(17),"giap_viet2_l","bo_pw_armor_body", spr_buy_item_triggers("itm_samurai_old", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], engineer=6)),
  ("pw_buy_asian_lamellar_vest",spr_buy_item_flags(11),"giap_viet1_x","bo_pw_armor_body", spr_buy_item_triggers("itm_asian_lamellar_vest", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=4)),
  ("pw_buy_asian_lamellar_shirt",spr_buy_item_flags(11),"giap_viet3","bo_pw_armor_body", spr_buy_item_triggers("itm_asian_lamellar_shirt", resources=["itm_iron_bar_short","itm_linen_cloth"], engineer=4)),
  ("pws_buy_traditional_armor",spr_buy_item_flags(17),"giap_viet5","bo_pw_armor_body", spr_buy_item_triggers("itm_ancient_japan_armor", resources=[("itm_iron_bar",2),"itm_leather_piece","itm_linen_cloth"], engineer=6)),
  
   ("pws_buy_match_rifle",spr_buy_item_flags(2),"matchlock_1","bo_pw_weapon", spr_buy_item_triggers("itm_matchlock_a", resources=["itm_wood_pole", "itm_iron_piece"], engineer=7)),
   ("pws_buy_match_rifle_b",spr_buy_item_flags(2),"matchlock_2","bo_pw_weapon", spr_buy_item_triggers("itm_matchlock_b", resources=["itm_wood_pole", "itm_iron_piece"], engineer=7)),
     ("pws_buy_cartridges",spr_buy_item_flags(1),"cartridge_a","bo_pw_weapon_small", spr_buy_item_triggers("itm_cartridges", resources=[], engineer=1)),
 ...
 ("gekokujo_v_house_1", 0, "gekokujo_v_house_1", "bo_gekokujo_v_house_1", []),
  ...
  ("gekokujo_t_temple", 0, "gekokujo_t_temple", "bo_gekokujo_t_temple", spr_well_triggers()),
  ...
  ("gekokujo_v2_house_4", 0, "gekokujo_v2_house_4", "bo_gekokujo_v2_house_4", []),
   ...
   ("pws_buy_elephant",spr_buy_item_flags(10),"yf_ydzx","bo_yf_ydzx", spr_buy_item_triggers("itm_elephant", resources=["itm_saddle", "itm_horse_armor", "itm_silver_bar", "itm_gold_bar"], herding=3)),
   
   #1.1 add
    ("pws_buy_gekokujo_practice_yari",spr_buy_item_flags(1),"gekokujo_practice_yari","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_practice_yari", resources=["itm_wood_pole"], engineer=1)),
 ("pws_buy_gekokujo_practice_nodachi",spr_buy_item_flags(14),"gekokujo_practice_nodachi","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_practice_nodachi", resources=["itm_iron_bar_long"], engineer=6)),
  ("pws_buy_gekokujo_practice_katana",spr_buy_item_flags(1),"gekokujo_practice_katana","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_practice_katana", resources=["itm_wood_pole_short"], engineer=2)),
 ("pws_buy_gekokujo_practice_wakizashi",spr_buy_item_flags(1),"gekokujo_practice_wakizashi","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_practice_wakizashi", resources=["itm_wood_pole_short"], engineer=2)),
 ("pws_buy_gekokujo_practice_naginata",spr_buy_item_flags(1),"gekokujo_practice_naginata","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_practice_naginata", resources=["itm_wood_pole"], engineer=1)),
("pws_buy_gekokujo_practice_kunai",spr_buy_item_flags(1),"gekokujo_practice_kunai","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_practice_kunai", resources=["itm_stick"], engineer=2)),

("pws_buy_gekokujo_katana_1",spr_buy_item_flags(7),"gekokujo_katana_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_1", resources=["itm_iron_bar"], engineer=3)),
("pws_buy_gekokujo_katana_2",spr_buy_item_flags(7),"gekokujo_katana_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_2", resources=["itm_iron_bar"], engineer=3)),
("pws_buy_gekokujo_katana_3",spr_buy_item_flags(7),"gekokujo_katana_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_3", resources=["itm_iron_bar"], engineer=3)),
("pws_buy_gekokujo_katana_4",spr_buy_item_flags(7),"gekokujo_katana_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_4", resources=["itm_iron_bar"], engineer=3)),
("pws_buy_gekokujo_katana_5",spr_buy_item_flags(7),"gekokujo_katana_5","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_5", resources=["itm_iron_bar"], engineer=4)),
("pws_buy_gekokujo_katana_6",spr_buy_item_flags(7),"gekokujo_katana_6","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_6", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_katana_7",spr_buy_item_flags(7),"gekokujo_katana_7","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_7", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_katana_8",spr_buy_item_flags(7),"gekokujo_katana_8","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_8", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_katana_9",spr_buy_item_flags(7),"gekokujo_katana_9","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_9", resources=["itm_iron_bar"], engineer=6)),
 ("pws_buy_gekokujo_katana_10",spr_buy_item_flags(7),"gekokujo_katana_10","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_katana_10", resources=["itm_iron_bar"], engineer=6)),
 
 ("pws_buy_gekokujo_wakizashi_1",spr_buy_item_flags(7),"gekokujo_wakizashi_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_1", resources=["itm_iron_bar"], engineer=3)),
("pws_buy_gekokujo_wakizashi_2",spr_buy_item_flags(7),"gekokujo_wakizashi_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_2", resources=["itm_iron_bar"], engineer=3)), 
 ("pws_buy_gekokujo_wakizashi_3",spr_buy_item_flags(7),"gekokujo_wakizashi_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_3", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_wakizashi_4",spr_buy_item_flags(7),"gekokujo_wakizashi_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_4", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_wakizashi_5",spr_buy_item_flags(7),"gekokujo_wakizashi_5","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_5", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_wakizashi_6",spr_buy_item_flags(7),"gekokujo_wakizashi_6","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_6", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_wakizashi_7",spr_buy_item_flags(7),"gekokujo_wakizashi_7","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_7", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_wakizashi_8",spr_buy_item_flags(7),"gekokujo_wakizashi_8","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_8", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_wakizashi_9",spr_buy_item_flags(7),"gekokujo_wakizashi_9","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_9", resources=["itm_iron_bar"], engineer=6)),
 ("pws_buy_gekokujo_wakizashi_10",spr_buy_item_flags(7),"gekokujo_wakizashi_10","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_wakizashi_10", resources=["itm_iron_bar"], engineer=6)),
 
 ("pws_buy_gekokujo_tanto_1",spr_buy_item_flags(6),"gekokujo_tanto_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_1", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tanto_2",spr_buy_item_flags(6),"gekokujo_tanto_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_2", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tanto_3",spr_buy_item_flags(6),"gekokujo_tanto_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_3", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tanto_4",spr_buy_item_flags(6),"gekokujo_tanto_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_4", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tanto_5",spr_buy_item_flags(6),"gekokujo_tanto_5","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_5", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_tanto_6",spr_buy_item_flags(6),"gekokujo_tanto_6","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_6", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_tanto_7",spr_buy_item_flags(6),"gekokujo_tanto_7","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_7", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_tanto_8",spr_buy_item_flags(6),"gekokujo_tanto_8","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_8", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_tanto_9",spr_buy_item_flags(6),"gekokujo_tanto_9","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_9", resources=["itm_iron_bar"], engineer=6)),
 ("pws_buy_gekokujo_tanto_10",spr_buy_item_flags(6),"gekokujo_tanto_10","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tanto_10", resources=["itm_iron_bar"], engineer=6)),
 
 ("pws_buy_gekokujo_nodachi_1",spr_buy_item_flags(7),"gekokujo_nodachi_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_1", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_nodachi_2",spr_buy_item_flags(7),"gekokujo_nodachi_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_2", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_nodachi_3",spr_buy_item_flags(7),"gekokujo_nodachi_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_3", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_nodachi_4",spr_buy_item_flags(7),"gekokujo_nodachi_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_4", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_nodachi_5",spr_buy_item_flags(7),"gekokujo_nodachi_5","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_5", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_nodachi_6",spr_buy_item_flags(7),"gekokujo_nodachi_6","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_6", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_nodachi_7",spr_buy_item_flags(7),"gekokujo_nodachi_7","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_7", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_nodachi_8",spr_buy_item_flags(7),"gekokujo_nodachi_8","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_8", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_nodachi_9",spr_buy_item_flags(7),"gekokujo_nodachi_9","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_9", resources=["itm_iron_bar"], engineer=6)),
 ("pws_buy_gekokujo_nodachi_10",spr_buy_item_flags(7),"gekokujo_nodachi_10","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nodachi_10", resources=["itm_iron_bar"], engineer=6)),
 
 ("pws_buy_gekokujo_tachi_1",spr_buy_item_flags(7),"gekokujo_tachi_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_1", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tachi_2",spr_buy_item_flags(7),"gekokujo_tachi_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_2", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tachi_3",spr_buy_item_flags(7),"gekokujo_tachi_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_3", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tachi_4",spr_buy_item_flags(7),"gekokujo_tachi_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_4", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_tachi_5",spr_buy_item_flags(7),"gekokujo_tachi_5","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_5", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_tachi_6",spr_buy_item_flags(7),"gekokujo_tachi_6","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_6", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_tachi_7",spr_buy_item_flags(7),"gekokujo_tachi_7","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_7", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_tachi_8",spr_buy_item_flags(7),"gekokujo_tachi_8","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_8", resources=["itm_iron_bar"], engineer=5)),
 ("pws_buy_gekokujo_tachi_9",spr_buy_item_flags(7),"gekokujo_tachi_9","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_9", resources=["itm_iron_bar"], engineer=6)),
 ("pws_buy_gekokujo_tachi_10",spr_buy_item_flags(7),"gekokujo_tachi_10","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_tachi_10", resources=["itm_iron_bar"], engineer=6)),
 
 ("pws_buy_gekokujo_naginata_1",spr_buy_item_flags(2),"gekokujo_naginata_1","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_1", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=2)),
 ("pws_buy_gekokujo_naginata_2",spr_buy_item_flags(2),"gekokujo_naginata_2","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_2", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=2)),
 ("pws_buy_gekokujo_naginata_3",spr_buy_item_flags(2),"gekokujo_naginata_3","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_3", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=3)),
 ("pws_buy_gekokujo_naginata_4",spr_buy_item_flags(2),"gekokujo_naginata_4","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_4", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=3)),
 ("pws_buy_gekokujo_naginata_5",spr_buy_item_flags(2),"gekokujo_naginata_5","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_5", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=4)),
 ("pws_buy_gekokujo_naginata_6",spr_buy_item_flags(2),"gekokujo_naginata_6","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_6", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=4)),
 ("pws_buy_gekokujo_naginata_7",spr_buy_item_flags(2),"gekokujo_naginata_7","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_7", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=5)),
 ("pws_buy_gekokujo_naginata_8",spr_buy_item_flags(2),"gekokujo_naginata_8","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_8", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=5)),
 ("pws_buy_gekokujo_naginata_9",spr_buy_item_flags(2),"gekokujo_naginata_9","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_9", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=6)),
 ("pws_buy_gekokujo_naginata_10",spr_buy_item_flags(2),"gekokujo_naginata_10","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_naginata_10", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=6)),
 
 ("pws_buy_gekokujo_nagamaki_1",spr_buy_item_flags(13),"gekokujo_nagamaki_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_1", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_2",spr_buy_item_flags(13),"gekokujo_nagamaki_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_2", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_3",spr_buy_item_flags(13),"gekokujo_nagamaki_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_3", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_4",spr_buy_item_flags(13),"gekokujo_nagamaki_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_4", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_5",spr_buy_item_flags(13),"gekokujo_nagamaki_5","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_5", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_6",spr_buy_item_flags(13),"gekokujo_nagamaki_6","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_6", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_7",spr_buy_item_flags(13),"gekokujo_nagamaki_7","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_7", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_8",spr_buy_item_flags(13),"gekokujo_nagamaki_8","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_8", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_9",spr_buy_item_flags(13),"gekokujo_nagamaki_9","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_9", resources=["itm_iron_bar_long"], engineer=6)),
 ("pws_buy_gekokujo_nagamaki_10",spr_buy_item_flags(13),"gekokujo_nagamaki_10","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_nagamaki_10", resources=["itm_iron_bar_long"], engineer=6)),
 
 ("pws_buy_gekokujo_ninjato_1",spr_buy_item_flags(7),"gekokujo_ninjato_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_ninjato_1", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_ninjato_2",spr_buy_item_flags(7),"gekokujo_ninjato_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_ninjato_2", resources=["itm_iron_bar"], engineer=3)),
 ("pws_buy_gekokujo_ninjato_3",spr_buy_item_flags(7),"gekokujo_ninjato_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_ninjato_3", resources=["itm_iron_bar"], engineer=4)),
 ("pws_buy_gekokujo_ninjato_4",spr_buy_item_flags(7),"gekokujo_ninjato_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_ninjato_4", resources=["itm_iron_bar"], engineer=5)),
 
 ("pws_buy_gekokujo_fukuro_yari_1",spr_buy_item_flags(2),"gekokujo_fukuro_yari_1","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_fukuro_yari_1", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=2)),
 ("pws_buy_gekokujo_fukuro_yari_2",spr_buy_item_flags(2),"gekokujo_fukuro_yari_2","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_fukuro_yari_2", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=3)),
 ("pws_buy_gekokujo_fukuro_yari_3",spr_buy_item_flags(2),"gekokujo_fukuro_yari_3","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_fukuro_yari_3", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=3)),
 ("pws_buy_gekokujo_fukuro_yari_4",spr_buy_item_flags(2),"gekokujo_fukuro_yari_4","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_fukuro_yari_4", resources=["itm_wood_pole", "itm_iron_bar", "itm_linen_cloth"], engineer=4)),
 
 ("pws_buy_gekokujo_yumi_1",spr_buy_item_flags(4),"gekokujo_yumi_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_1", resources=["itm_wood_pole"], engineer=3)),
 ("pws_buy_gekokujo_yumi_2",spr_buy_item_flags(4),"gekokujo_yumi_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_2", resources=["itm_wood_pole"], engineer=3)),
 ("pws_buy_gekokujo_yumi_3",spr_buy_item_flags(4),"gekokujo_yumi_3","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_3", resources=["itm_wood_pole"], engineer=4)),
 ("pws_buy_gekokujo_yumi_4",spr_buy_item_flags(4),"gekokujo_yumi_4","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_4", resources=["itm_wood_pole"], engineer=4)),
 ("pws_buy_gekokujo_yumi_5",spr_buy_item_flags(4),"gekokujo_yumi_5","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_5", resources=["itm_wood_pole"], engineer=5)),
 ("pws_buy_gekokujo_yumi_6",spr_buy_item_flags(4),"gekokujo_yumi_6","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_6", resources=["itm_wood_pole"], engineer=5)),
 ("pws_buy_gekokujo_yumi_7",spr_buy_item_flags(4),"gekokujo_yumi_7","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_7", resources=["itm_wood_pole"], engineer=6)),
 ("pws_buy_gekokujo_yumi_8",spr_buy_item_flags(4),"gekokujo_yumi_8","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_8", resources=["itm_wood_pole"], engineer=6)),
 ("pws_buy_gekokujo_yumi_9",spr_buy_item_flags(4),"gekokujo_yumi_9","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_yumi_9", resources=["itm_wood_pole"], engineer=7)),
 
 ("pws_buy_gekokujo_kama_1",spr_buy_item_flags(3),"gekokujo_kama_1","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_kama_1", resources=["itm_iron_bar_short", "itm_wood_pole_short"], engineer=2)),
 ("pws_buy_gekokujo_kama_2",spr_buy_item_flags(3),"gekokujo_kama_2","bo_pw_weapon", spr_buy_item_triggers("itm_gekokujo_kama_2", resources=["itm_iron_bar_short", "itm_wood_pole_short"], engineer=2)),
 
 ("pws_buy_gekokujo_konsaibo_1",spr_buy_item_flags(4),"gekokujo_konsaibo_1","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_konsaibo_1", resources=["itm_iron_bar_short", "itm_wood_pole"], engineer=3)),
 ("pws_buy_gekokujo_konsaibo_2",spr_buy_item_flags(4),"gekokujo_konsaibo_2","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_konsaibo_2", resources=["itm_iron_bar_short", "itm_wood_pole"], engineer=3)),
 ("pws_buy_gekokujo_tetsubo_1",spr_buy_item_flags(4),"gekokujo_tetsubo_1","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_tetsubo_1", resources=["itm_iron_bar_short", "itm_wood_pole"], engineer=3)),
 ("pws_buy_gekokujo_tetsubo_2",spr_buy_item_flags(4),"gekokujo_tetsubo_2","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_tetsubo_2", resources=["itm_iron_bar_short", "itm_wood_pole"], engineer=3)),
 ("pws_buy_gekokujo_kanabo_practice",spr_buy_item_flags(4),"gekokujo_kanabo_practice","bo_pw_weapon_big", spr_buy_item_triggers("itm_gekokujo_kanabo_practice", resources=["itm_iron_bar_short", "itm_wood_pole"], engineer=3)),
 
 ("pws_buy_gekokujo_shuriken",spr_buy_item_flags(3),"gekokujo_shuriken","bo_pw_weapon_small", spr_buy_item_triggers("itm_gekokujo_shuriken", resources=["itm_iron_bar_short"], engineer=3)),
 
 #1.2 add
   ("pws_buy_gekokujo_kimono_1_1",spr_buy_item_flags(3),"gekokujo_kimono_1_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_1_1", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_1_2",spr_buy_item_flags(3),"gekokujo_kimono_1_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_1_2", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_1_3",spr_buy_item_flags(3),"gekokujo_kimono_1_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_1_3", resources=["itm_linen_cloth"], tailoring=1)),
   
   ("pws_buy_gekokujo_kimono_2_1",spr_buy_item_flags(3),"gekokujo_kimono_2_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_2_1", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_2_2",spr_buy_item_flags(3),"gekokujo_kimono_2_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_2_2", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_2_3",spr_buy_item_flags(3),"gekokujo_kimono_2_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_2_3", resources=["itm_linen_cloth"], tailoring=1)),
   
   ("pws_buy_gekokujo_kimono_3_1",spr_buy_item_flags(3),"gekokujo_kimono_3_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_3_1", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_3_2",spr_buy_item_flags(3),"gekokujo_kimono_3_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_3_2", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_3_3",spr_buy_item_flags(3),"gekokujo_kimono_3_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_3_3", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_3_4",spr_buy_item_flags(3),"gekokujo_kimono_3_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_3_4", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_3_5",spr_buy_item_flags(3),"gekokujo_kimono_3_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_3_5", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_kimono_3_6",spr_buy_item_flags(3),"gekokujo_kimono_3_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_3_6", resources=["itm_linen_cloth"], tailoring=1)),
   
   ("pws_buy_gekokujo_hakama_1_1",spr_buy_item_flags(3),"gekokujo_hakama_1_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_hakama_1", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_hakama_1_2",spr_buy_item_flags(3),"gekokujo_hakama_1_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_hakama_2", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_hakama_1_3",spr_buy_item_flags(3),"gekokujo_hakama_1_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_hakama_3", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_hakama_1_4",spr_buy_item_flags(3),"gekokujo_hakama_1_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_hakama_4", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_hakama_1_5",spr_buy_item_flags(3),"gekokujo_hakama_1_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_hakama_5", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_hakama_1_6",spr_buy_item_flags(3),"gekokujo_hakama_1_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_hakama_6", resources=["itm_linen_cloth"], tailoring=1)),
   
   ("pws_buy_gekokujo_kimono_2_monk",spr_buy_item_flags(3),"gekokujo_kimono_2_monk","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kimono_2_monk", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_hakama_1_miko",spr_buy_item_flags(3),"gekokujo_hakama_1_miko","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_hakama_1_miko", resources=["itm_linen_cloth"], tailoring=1)),
   
   ("pws_buy_gekokujo_ezo_armor_1",spr_buy_item_flags(3),"gekokujo_ezo_armor_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_ezo_armor_1", resources=["itm_linen_cloth","itm_leather_piece"], tailoring=1)),
   ("pws_buy_gekokujo_ezo_robes_1",spr_buy_item_flags(3),"gekokujo_ezo_robes_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_ezo_robes_1", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_ezo_robes_2",spr_buy_item_flags(3),"gekokujo_ezo_robes_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_ezo_robes_2", resources=["itm_linen_cloth"], tailoring=1)),
   ("pws_buy_gekokujo_ezo_robes_3",spr_buy_item_flags(3),"gekokujo_ezo_robes_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_ezo_robes_3", resources=["itm_linen_cloth"], tailoring=1)),
   
   ("pws_buy_gekokujo_shoe_ta_tabi",spr_buy_item_flags(6),"gekokujo_tabi","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_tabi", resources=["itm_linen_cloth_small"], tailoring=1)),
   
   ("pws_buy_gekokujo_shoe_tb_sandal_1",spr_buy_item_flags(6),"gekokujo_sandal_1","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_sandal_1", resources=[("itm_linen_cloth_small",2)], engineer=1)),
   ("pws_buy_gekokujo_shoe_tb_sandal_2",spr_buy_item_flags(6),"gekokujo_sandal_2","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_sandal_2", resources=[("itm_linen_cloth_small",2)], engineer=1)),
   ("pws_buy_gekokujo_shoe_tb_sandal_3",spr_buy_item_flags(6),"gekokujo_sandal_3","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_sandal_3", resources=[("itm_linen_cloth_small",2)], engineer=1)),
   
   ("pws_buy_gekokujo_shoe_tc_light_suneate_1",spr_buy_item_flags(6),"gekokujo_light_suneate_1","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_light_suneate_1", resources=[("itm_linen_cloth_small",2), "itm_leather_piece"], engineer=3)),
   ("pws_buy_gekokujo_shoe_tc_light_suneate_2",spr_buy_item_flags(6),"gekokujo_light_suneate_2","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_light_suneate_2", resources=[("itm_linen_cloth_small",2), "itm_leather_piece"], engineer=3)),
   ("pws_buy_gekokujo_shoe_tc_light_suneate_3",spr_buy_item_flags(6),"gekokujo_light_suneate_3","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_light_suneate_3", resources=[("itm_linen_cloth_small",2), "itm_leather_piece"], engineer=3)),
   
   ("pws_buy_gekokujo_shoe_td_shino_suneate_1",spr_buy_item_flags(6),"gekokujo_shino_suneate_1","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_shino_suneate_1", resources=["itm_linen_cloth", "itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_shoe_td_shino_suneate_2",spr_buy_item_flags(6),"gekokujo_shino_suneate_2","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_shino_suneate_2", resources=["itm_linen_cloth", "itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_shoe_td_shino_suneate_3",spr_buy_item_flags(6),"gekokujo_shino_suneate_3","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_shino_suneate_3", resources=["itm_linen_cloth", "itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_shoe_te_tsubo_suneate_1",spr_buy_item_flags(6),"gekokujo_tsubo_suneate_1","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_tsubo_suneate_1", resources=["itm_linen_cloth", "itm_leather_roll"], engineer=5)),
   ("pws_buy_gekokujo_shoe_te_tsubo_suneate_2",spr_buy_item_flags(6),"gekokujo_tsubo_suneate_3","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_tsubo_suneate_2", resources=["itm_linen_cloth", "itm_leather_roll"], engineer=5)),
   ("pws_buy_gekokujo_shoe_te_tsubo_suneate_3",spr_buy_item_flags(6),"gekokujo_tsubo_suneate_2","bo_pw_armor_foot", spr_buy_item_triggers("itm_gekokujo_tsubo_suneate_3", resources=["itm_linen_cloth", "itm_leather_roll"], engineer=5)),
   
   ("pws_buy_gekokujo_tatami_short_1",spr_buy_item_flags(11),"gekokujo_tatami_short_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_short_1", resources=["itm_leather_roll","itm_linen_cloth"], engineer=4)),
   ("pws_buy_gekokujo_tatami_short_2",spr_buy_item_flags(11),"gekokujo_tatami_short_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_short_2", resources=["itm_leather_roll","itm_linen_cloth"], engineer=4)),
   ("pws_buy_gekokujo_tatami_short_3",spr_buy_item_flags(11),"gekokujo_tatami_short_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_short_3", resources=["itm_leather_roll","itm_linen_cloth"], engineer=4)),
   ("pws_buy_gekokujo_tatami_short_4",spr_buy_item_flags(11),"gekokujo_tatami_short_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_short_4", resources=["itm_leather_roll","itm_linen_cloth"], engineer=4)),
   ("pws_buy_gekokujo_tatami_short_5",spr_buy_item_flags(11),"gekokujo_tatami_short_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_short_5", resources=["itm_leather_roll","itm_linen_cloth"], engineer=4)),
   ("pws_buy_gekokujo_tatami_short_6",spr_buy_item_flags(11),"gekokujo_tatami_short_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_short_6", resources=["itm_leather_roll","itm_linen_cloth"], engineer=4)),
   
   ("pws_buy_gekokujo_tatami_half_1",spr_buy_item_flags(11),"gekokujo_tatami_half_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_half_1", resources=["itm_leather_piece","itm_linen_cloth"], engineer=4)),
   ("pws_buy_gekokujo_tatami_half_2",spr_buy_item_flags(11),"gekokujo_tatami_half_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_half_1", resources=["itm_leather_piece","itm_linen_cloth"], engineer=4)),
   ("pws_buy_gekokujo_tatami_half_3",spr_buy_item_flags(11),"gekokujo_tatami_half_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_tatami_half_1", resources=["itm_leather_piece","itm_linen_cloth"], engineer=4)),
   
   ("pws_buy_gekokujo_okegawa_long_1",spr_buy_item_flags(11),"gekokujo_okegawa_long_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_long_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_long_2",spr_buy_item_flags(11),"gekokujo_okegawa_long_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_long_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_long_3",spr_buy_item_flags(11),"gekokujo_okegawa_long_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_long_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_long_4",spr_buy_item_flags(11),"gekokujo_okegawa_long_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_long_4", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_long_5",spr_buy_item_flags(11),"gekokujo_okegawa_long_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_long_5", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_long_6",spr_buy_item_flags(11),"gekokujo_okegawa_long_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_long_6", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_okegawa_short_uesugi",spr_buy_item_flags(11),"gekokujo_okegawa_short_uesugi","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_uesugi", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_oda",spr_buy_item_flags(11),"gekokujo_okegawa_short_oda","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_oda", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_mori",spr_buy_item_flags(11),"gekokujo_okegawa_short_mori","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_mori", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_takeda",spr_buy_item_flags(11),"gekokujo_okegawa_short_takeda","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_takeda", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_tokugawa",spr_buy_item_flags(11),"gekokujo_okegawa_short_tokugawa","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_tokugawa", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_okegawa_short_1",spr_buy_item_flags(11),"gekokujo_okegawa_short_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_2",spr_buy_item_flags(11),"gekokujo_okegawa_short_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_3",spr_buy_item_flags(11),"gekokujo_okegawa_short_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_4",spr_buy_item_flags(11),"gekokujo_okegawa_short_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_4", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_5",spr_buy_item_flags(11),"gekokujo_okegawa_short_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_5", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_6",spr_buy_item_flags(11),"gekokujo_okegawa_short_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_6", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_7",spr_buy_item_flags(11),"gekokujo_okegawa_short_7","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_7", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_8",spr_buy_item_flags(11),"gekokujo_okegawa_short_8","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_8", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_9",spr_buy_item_flags(11),"gekokujo_okegawa_short_9","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_9", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_10",spr_buy_item_flags(11),"gekokujo_okegawa_short_10","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_10", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_11",spr_buy_item_flags(11),"gekokujo_okegawa_short_11","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_11", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_short_12",spr_buy_item_flags(11),"gekokujo_okegawa_short_12","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_short_12", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_okegawa_half_uesugi",spr_buy_item_flags(11),"gekokujo_okegawa_half_uesugi","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_half_uesugi", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_half_oda",spr_buy_item_flags(11),"gekokujo_okegawa_half_oda","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_half_oda", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_half_mori",spr_buy_item_flags(11),"gekokujo_okegawa_half_mori","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_half_mori", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_half_takeda",spr_buy_item_flags(11),"gekokujo_okegawa_half_takeda","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_half_takeda", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_okegawa_half_tokugawa",spr_buy_item_flags(11),"gekokujo_okegawa_half_tokugawa","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_okegawa_half_tokugawa", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_mogami_half_1",spr_buy_item_flags(11),"gekokujo_mogami_half_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_half_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_mogami_half_2",spr_buy_item_flags(11),"gekokujo_mogami_half_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_half_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_mogami_half_3",spr_buy_item_flags(11),"gekokujo_mogami_half_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_half_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_yukinoshita_long_1",spr_buy_item_flags(11),"gekokujo_yukinoshita_long_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_yukinoshita_long_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_yukinoshita_long_2",spr_buy_item_flags(11),"gekokujo_yukinoshita_long_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_yukinoshita_long_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_yukinoshita_long_3",spr_buy_item_flags(11),"gekokujo_yukinoshita_long_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_yukinoshita_long_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_mogami_short_1",spr_buy_item_flags(11),"gekokujo_mogami_short_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_short_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_mogami_short_2",spr_buy_item_flags(11),"gekokujo_mogami_short_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_short_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_mogami_short_3",spr_buy_item_flags(11),"gekokujo_mogami_short_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_short_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_mogami_short_4",spr_buy_item_flags(11),"gekokujo_mogami_short_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_short_4", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_mogami_short_5",spr_buy_item_flags(11),"gekokujo_mogami_short_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_short_5", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_mogami_short_6",spr_buy_item_flags(11),"gekokujo_mogami_short_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_mogami_short_6", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_nuinobe_long_1",spr_buy_item_flags(11),"gekokujo_nuinobe_long_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nuinobe_long_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_nuinobe_long_2",spr_buy_item_flags(11),"gekokujo_nuinobe_long_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nuinobe_long_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_nuinobe_long_3",spr_buy_item_flags(11),"gekokujo_nuinobe_long_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nuinobe_long_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_kebiki_1",spr_buy_item_flags(11),"gekokujo_kebiki_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_2",spr_buy_item_flags(11),"gekokujo_kebiki_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_3",spr_buy_item_flags(11),"gekokujo_kebiki_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_4",spr_buy_item_flags(11),"gekokujo_kebiki_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_4", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_5",spr_buy_item_flags(11),"gekokujo_kebiki_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_5", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_6",spr_buy_item_flags(11),"gekokujo_kebiki_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_6", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_7",spr_buy_item_flags(11),"gekokujo_kebiki_7","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_7", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_8",spr_buy_item_flags(11),"gekokujo_kebiki_8","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_8", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_9",spr_buy_item_flags(11),"gekokujo_kebiki_9","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_9", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_10",spr_buy_item_flags(11),"gekokujo_kebiki_10","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_10", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_11",spr_buy_item_flags(11),"gekokujo_kebiki_11","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_11", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_12",spr_buy_item_flags(11),"gekokujo_kebiki_12","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_12", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_13",spr_buy_item_flags(11),"gekokujo_kebiki_13","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_13", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_14",spr_buy_item_flags(11),"gekokujo_kebiki_14","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_14", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_15",spr_buy_item_flags(11),"gekokujo_kebiki_15","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_15", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_16",spr_buy_item_flags(11),"gekokujo_kebiki_16","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_16", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_17",spr_buy_item_flags(11),"gekokujo_kebiki_17","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_17", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_18",spr_buy_item_flags(11),"gekokujo_kebiki_18","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_18", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_19",spr_buy_item_flags(11),"gekokujo_kebiki_19","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_19", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_20",spr_buy_item_flags(11),"gekokujo_kebiki_20","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_20", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_kebiki_21",spr_buy_item_flags(11),"gekokujo_kebiki_21","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_kebiki_21", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   
   ("pws_buy_gekokujo_nanban_1",spr_buy_item_flags(11),"gekokujo_nanban_1","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nanban_1", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_nanban_2",spr_buy_item_flags(11),"gekokujo_nanban_2","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nanban_2", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_nanban_3",spr_buy_item_flags(11),"gekokujo_nanban_3","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nanban_3", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_nanban_4",spr_buy_item_flags(11),"gekokujo_nanban_4","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nanban_4", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_nanban_5",spr_buy_item_flags(11),"gekokujo_nanban_5","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nanban_5", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),
   ("pws_buy_gekokujo_nanban_6",spr_buy_item_flags(11),"gekokujo_nanban_6","bo_pw_armor_body", spr_buy_item_triggers("itm_gekokujo_nanban_6", resources=["itm_iron_bar_short","itm_linen_cloth","itm_leather_piece"], engineer=4)),

   #1.3 add - classes and hats (and interiors)
   
  ("pws_change_troop_farmer",spr_use_time(30),"trident","bo_pw_weapon_big", spr_change_troop_triggers("trp_farmer", cost=150)),
  ("pws_change_troop_levy",spr_use_time(30),"gekokujo_practice_katana","bo_pw_weapon", spr_change_troop_triggers("trp_levy", cost=500)),
  ("pws_change_troop_hunter",spr_use_time(30),"gekokujo_yumi_1","bo_pw_weapon", spr_change_troop_triggers("trp_hunter", cost=500)),
  ("pws_change_troop_tailor",spr_use_time(50),"pw_repair_hammer","bo_pw_weapon_small", spr_change_troop_triggers("trp_tailor", cost=800)),
  ("pws_change_troop_retainer",spr_use_time(60),"gekokujo_practice_katana","bo_pw_weapon", spr_change_troop_triggers("trp_retainer", cost=1000)),
  ("pws_change_troop_bow_master",spr_use_time(60),"gekokujo_yumi_1","bo_pw_weapon", spr_change_troop_triggers("trp_bow_master", cost=1100)),
  ("pws_change_troop_sharpshooter",spr_use_time(60),"crossbow_a","bo_pw_weapon", spr_change_troop_triggers("trp_sharpshooter", cost=1200)),
  ("pws_change_troop_outrider",spr_use_time(70),"arena_lance","bo_pw_weapon_big", spr_change_troop_triggers("trp_outrider", cost=1500)),
  ("pws_change_troop_cavalry",spr_use_time(90),"arena_lance","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_cavalry", cost=5000)),
  ("pws_change_troop_samauri",spr_use_time(90),"gekokujo_practice_katana","bo_pw_shield_kite_small", spr_change_troop_triggers("trp_samauri", cost=5000)),
  ("pws_change_troop_architect",spr_use_time(80),"pw_repair_hammer","bo_pw_weapon_small", spr_change_troop_triggers("trp_architect", cost=2500)),
  ("pws_change_troop_blacksmith",spr_use_time(120),"pw_repair_hammer","bo_pw_weapon_small", spr_change_troop_triggers("trp_blacksmith", cost=7500)),
  ("pws_change_troop_physician",spr_use_time(100),"package","bobaggage", spr_change_troop_triggers("trp_physician", cost=3500)),
  ("pws_change_troop_funanori",spr_use_time(70),"scimeter","bo_pw_weapon", spr_change_troop_triggers("trp_funanori", cost=2000)),
  ("pws_change_troop_explorer",spr_use_time(70),"quarter_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_explorer", cost=1300, use_string="str_troop_become")),
  ("pws_change_troop_shepherd",spr_use_time(40),"quarter_staff","bo_pw_weapon_big", spr_change_troop_triggers("trp_shepherd", cost=900)),
  ("pws_change_troop_thug",spr_use_time(40),"sledgehammer","bo_pw_weapon", spr_change_troop_triggers("trp_thug", cost=800, after_respawn=True, use_string="str_troop_become")),
  ("pws_change_troop_thief",spr_use_time(50),"spiked_club","bo_pw_weapon", spr_change_troop_triggers("trp_thief", cost=900, after_respawn=True, use_string="str_troop_become")),
  ("pws_change_troop_ninja",spr_use_time(50),"gekokujo_shuriken","bo_pw_weapon", spr_change_troop_triggers("trp_ninja", cost=5000, after_respawn=True, use_string="str_troop_become_for")),

  
  ("pws_buy_hat_gekokujo_sugegasa_1",spr_buy_item_flags(2),"gekokujo_sugegasa","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_gekokujo_sugegasa_1", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_headwrap",spr_buy_item_flags(2),"gekokujo_headwrap","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_gekokujo_monk_headwrap", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_headwrap_black",spr_buy_item_flags(2),"gekokujo_headwrap_black","bo_pw_armor_head_armature", spr_buy_item_triggers("itm_gekokujo_ninja_headwrap", resources=["itm_linen_cloth_small"], tailoring=2)),
  
  ("pws_buy_hat_gekokujo_jingasa_1",spr_buy_item_flags(2),"gekokujo_jingasa_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_1", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_2",spr_buy_item_flags(2),"gekokujo_jingasa_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_2", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_3",spr_buy_item_flags(2),"gekokujo_jingasa_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_3", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_4",spr_buy_item_flags(2),"gekokujo_jingasa_4","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_4", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_5",spr_buy_item_flags(2),"gekokujo_jingasa_5","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_5", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_6",spr_buy_item_flags(2),"gekokujo_jingasa_6","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_6", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_7",spr_buy_item_flags(2),"gekokujo_jingasa_7","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_7", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_8",spr_buy_item_flags(2),"gekokujo_jingasa_8","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_8", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_9",spr_buy_item_flags(2),"gekokujo_jingasa_9","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_9", resources=["itm_linen_cloth_small"], tailoring=2)),
  
  ("pws_buy_hat_gekokujo_jingasa_uesugi",spr_buy_item_flags(2),"gekokujo_jingasa_uesugi","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_uesugi", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_date",spr_buy_item_flags(2),"gekokujo_jingasa_date","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_date", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_oda",spr_buy_item_flags(2),"gekokujo_jingasa_oda","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_oda", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_mori",spr_buy_item_flags(2),"gekokujo_jingasa_mori","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_mori", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_takeda",spr_buy_item_flags(2),"gekokujo_jingasa_takeda","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_takeda", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_tokugawa",spr_buy_item_flags(2),"gekokujo_jingasa_tokugawa","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_tokugawa", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_miyoshi",spr_buy_item_flags(2),"gekokujo_jingasa_miyoshi","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_miyoshi", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_amako",spr_buy_item_flags(2),"gekokujo_jingasa_amako","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_amako", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_otomo",spr_buy_item_flags(2),"gekokujo_jingasa_otomo","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_otomo", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_nanbu",spr_buy_item_flags(2),"gekokujo_jingasa_nanbu","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_nanbu", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_asakura",spr_buy_item_flags(2),"gekokujo_jingasa_asakura","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_asakura", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_chosokabe",spr_buy_item_flags(2),"gekokujo_jingasa_chosokabe","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_chosokabe", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_hojo",spr_buy_item_flags(2),"gekokujo_jingasa_hojo","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_hojo", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_mogami",spr_buy_item_flags(2),"gekokujo_jingasa_mogami","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_mogami", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_shimazu",spr_buy_item_flags(2),"gekokujo_jingasa_shimazu","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_shimazu", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_ryuzoji",spr_buy_item_flags(2),"gekokujo_jingasa_ryuzoji","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_ryuzoji", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_satake",spr_buy_item_flags(2),"gekokujo_jingasa_satake","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_satake", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_satomi",spr_buy_item_flags(2),"gekokujo_jingasa_satomi","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_satomi", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_ukita",spr_buy_item_flags(2),"gekokujo_jingasa_ukita","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_ukita", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pws_buy_hat_gekokujo_jingasa_ikko",spr_buy_item_flags(2),"gekokujo_jingasa_ikko","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_jingasa_ikko", resources=["itm_linen_cloth_small"], tailoring=2)),
   
  ("pws_buy_hat_gekokujo_hari_o_1",spr_buy_item_flags(2),"gekokujo_hari_o_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_hari_o_1", resources=["itm_leather_piece"], tailoring=2)),
  ("pws_buy_hat_gekokujo_hari_o_2",spr_buy_item_flags(2),"gekokujo_hari_o_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_hari_o_2", resources=["itm_leather_piece"], tailoring=2)),
  ("pws_buy_hat_gekokujo_hari_o_3",spr_buy_item_flags(2),"gekokujo_hari_o_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_hari_o_3", resources=["itm_leather_piece"], tailoring=2)),
  
  ("pws_buy_hat_gekokujo_suji_o_1",spr_buy_item_flags(2),"gekokujo_suji_o_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_suji_o_1", resources=["itm_leather_piece"], tailoring=2)),
  ("pws_buy_hat_gekokujo_suji_o_2",spr_buy_item_flags(2),"gekokujo_suji_o_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_suji_o_2", resources=["itm_leather_piece"], tailoring=2)),
  ("pws_buy_hat_gekokujo_suji_o_3",spr_buy_item_flags(2),"gekokujo_suji_o_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_suji_o_3", resources=["itm_leather_piece"], tailoring=2)),
  
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_o_1",spr_buy_item_flags(2),"gekokujo_shinomi_o_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_o_1", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_o_2",spr_buy_item_flags(2),"gekokujo_shinomi_o_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_o_2", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_o_3",spr_buy_item_flags(2),"gekokujo_shinomi_o_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_o_3", resources=["itm_leather_piece"], tailoring=3)),
  
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_h_1",spr_buy_item_flags(2),"gekokujo_shinomi_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_h_1", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_h_2",spr_buy_item_flags(2),"gekokujo_shinomi_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_h_2", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_h_3",spr_buy_item_flags(2),"gekokujo_shinomi_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_h_3", resources=["itm_leather_piece"], tailoring=3)),
  
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_m_1",spr_buy_item_flags(2),"gekokujo_shinomi_m_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_m_1", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_m_2",spr_buy_item_flags(2),"gekokujo_shinomi_m_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_m_2", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_gekokujo_shinomi_m_3",spr_buy_item_flags(2),"gekokujo_shinomi_m_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_shinomi_m_3", resources=["itm_leather_piece"], tailoring=3)),
  
  ("pws_buy_hat_gekokujo_zunari_h_1",spr_buy_item_flags(2),"gekokujo_zunari_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_zunari_h_1", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_zunari_h_2",spr_buy_item_flags(2),"gekokujo_zunari_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_zunari_h_2", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_zunari_h_3",spr_buy_item_flags(2),"gekokujo_zunari_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_zunari_h_3", resources=["itm_leather_piece"], tailoring=3)),
  
  ("pws_buy_hat_gekokujo_zunari_o_h_1",spr_buy_item_flags(2),"gekokujo_zunari_o_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_zunari_o_h_1", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_zunari_o_h_2",spr_buy_item_flags(2),"gekokujo_zunari_o_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_zunari_o_h_2", resources=["itm_leather_piece"], tailoring=3)),
  ("pws_buy_hat_gekokujo_zunari_o_h_3",spr_buy_item_flags(2),"gekokujo_zunari_o_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_zunari_o_h_3", resources=["itm_leather_piece"], tailoring=3)),
  
  ("pws_buy_hat_gekokujo_eboshi_h_1",spr_buy_item_flags(2),"gekokujo_eboshi_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_eboshi_h_1", resources=[("itm_leather_piece",2),], tailoring=4)),
  ("pws_buy_hat_gekokujo_eboshi_h_2",spr_buy_item_flags(2),"gekokujo_eboshi_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_eboshi_h_2", resources=[("itm_leather_piece",2),], tailoring=4)),
  ("pws_buy_hat_gekokujo_eboshi_h_3",spr_buy_item_flags(2),"gekokujo_eboshi_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_eboshi_h_3", resources=[("itm_leather_piece",2),], tailoring=4)),
  
  ("pws_buy_hat_gekokujo_eboshi_m_1",spr_buy_item_flags(2),"gekokujo_eboshi_m_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_eboshi_m_1", resources=[("itm_leather_piece",2),], tailoring=4)),
  ("pws_buy_hat_gekokujo_eboshi_m_2",spr_buy_item_flags(2),"gekokujo_eboshi_m_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_eboshi_m_2", resources=[("itm_leather_piece",2),], tailoring=4)),
  ("pws_buy_hat_gekokujo_eboshi_m_3",spr_buy_item_flags(2),"gekokujo_eboshi_m_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_eboshi_m_3", resources=[("itm_leather_piece",2),], tailoring=4)),
  
  ("pws_buy_hat_gekokujo_kabuto3_o_1",spr_buy_item_flags(2),"gekokujo_kabuto3_o_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_o_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_o_2",spr_buy_item_flags(2),"gekokujo_kabuto3_o_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_o_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_o_3",spr_buy_item_flags(2),"gekokujo_kabuto3_o_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_o_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto3_o_h_1",spr_buy_item_flags(2),"gekokujo_kabuto3_o_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_o_h_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_o_h_2",spr_buy_item_flags(2),"gekokujo_kabuto3_o_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_o_h_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_o_h_3",spr_buy_item_flags(2),"gekokujo_kabuto3_o_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_o_h_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto1_h_1",spr_buy_item_flags(2),"gekokujo_kabuto1_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto1_h_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto1_h_2",spr_buy_item_flags(2),"gekokujo_kabuto1_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto1_h_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto1_h_3",spr_buy_item_flags(2),"gekokujo_kabuto1_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto1_h_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto1_m_1",spr_buy_item_flags(2),"gekokujo_kabuto1_m_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto1_m_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto1_m_2",spr_buy_item_flags(2),"gekokujo_kabuto1_m_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto1_m_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto1_m_3",spr_buy_item_flags(2),"gekokujo_kabuto1_m_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto1_m_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto2_h_1",spr_buy_item_flags(2),"gekokujo_kabuto2_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto2_h_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto2_h_2",spr_buy_item_flags(2),"gekokujo_kabuto2_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto2_h_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto2_h_3",spr_buy_item_flags(2),"gekokujo_kabuto2_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto2_h_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto2_m_1",spr_buy_item_flags(2),"gekokujo_kabuto2_m_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto2_m_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto2_m_2",spr_buy_item_flags(2),"gekokujo_kabuto2_m_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto2_m_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto2_m_3",spr_buy_item_flags(2),"gekokujo_kabuto2_m_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto2_m_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto3_h_1",spr_buy_item_flags(2),"gekokujo_kabuto3_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_h_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_h_2",spr_buy_item_flags(2),"gekokujo_kabuto3_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_h_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_h_3",spr_buy_item_flags(2),"gekokujo_kabuto3_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_h_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto3_m_1",spr_buy_item_flags(2),"gekokujo_kabuto3_m_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_m_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_m_2",spr_buy_item_flags(2),"gekokujo_kabuto3_m_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_m_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto3_m_3",spr_buy_item_flags(2),"gekokujo_kabuto3_m_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto3_m_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto_nanban_h_1",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_h_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_h_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_h_2",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_h_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_h_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_h_3",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_h_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_h_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_h_4",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_h_4","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_h_4", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_h_5",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_h_5","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_h_5", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_h_6",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_h_6","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_h_6", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto_nanban_m_1",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_m_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_m_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_m_2",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_m_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_m_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_m_3",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_m_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_m_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_m_4",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_m_4","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_m_4", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_m_5",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_m_5","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_m_5", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_nanban_m_6",spr_buy_item_flags(2),"gekokujo_kabuto_nanban_m_6","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_nanban_m_6", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  ("pws_buy_hat_gekokujo_kabuto_unique_1",spr_buy_item_flags(2),"gekokujo_kabuto_unique_1","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_1", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_2",spr_buy_item_flags(2),"gekokujo_kabuto_unique_2","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_2", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_3",spr_buy_item_flags(2),"gekokujo_kabuto_unique_3","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_3", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_4",spr_buy_item_flags(2),"gekokujo_kabuto_unique_4","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_4", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_5",spr_buy_item_flags(2),"gekokujo_kabuto_unique_5","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_5", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_6",spr_buy_item_flags(2),"gekokujo_kabuto_unique_6","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_6", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_7",spr_buy_item_flags(2),"gekokujo_kabuto_unique_7","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_7", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_8",spr_buy_item_flags(2),"gekokujo_kabuto_unique_8","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_8", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_9",spr_buy_item_flags(2),"gekokujo_kabuto_unique_9","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_9", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_10",spr_buy_item_flags(2),"gekokujo_kabuto_unique_10","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_10", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_11",spr_buy_item_flags(2),"gekokujo_kabuto_unique_11","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_11", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_12",spr_buy_item_flags(2),"gekokujo_kabuto_unique_12","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_12", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_13",spr_buy_item_flags(2),"gekokujo_kabuto_unique_13","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_13", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_14",spr_buy_item_flags(2),"gekokujo_kabuto_unique_14","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_14", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_15",spr_buy_item_flags(2),"gekokujo_kabuto_unique_15","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_15", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_16",spr_buy_item_flags(2),"gekokujo_kabuto_unique_16","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_16", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_17",spr_buy_item_flags(2),"gekokujo_kabuto_unique_17","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_17", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_18",spr_buy_item_flags(2),"gekokujo_kabuto_unique_18","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_18", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_19",spr_buy_item_flags(2),"gekokujo_kabuto_unique_19","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_19", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  ("pws_buy_hat_gekokujo_kabuto_unique_20",spr_buy_item_flags(2),"gekokujo_kabuto_unique_20","bo_pw_armor_head", spr_buy_item_triggers("itm_gekokujo_kabuto_unique_20", resources=["itm_leather_roll","itm_iron_bar_short"], tailoring=5)),
  
  # from 'gekokujo_interiors.brf': begin (OpenBRF)
	( "gekokujo_interior_small"                    ,0,"gekokujo_interior_small","bo_gekokujo_interior_small",[]),
	( "gekokujo_interior_medium"                   ,0,"gekokujo_interior_medium","bo_gekokujo_interior_medium",[]),
	( "gekokujo_interior_inn"                      ,0,"gekokujo_interior_inn","bo_gekokujo_interior_inn",[]),
	( "gekokujo_interior_palace"                   ,0,"gekokujo_interior_palace","bo_gekokujo_interior_palace",[]),
	( "gekokujo_interior_dojo"                     ,0,"gekokujo_interior_dojo","bo_gekokujo_interior_dojo",[]),
# from 'gekokujo_interiors.brf': end (OpenBRF)

#1.4 more classes add

  ("pws_change_troop_horse_archer",spr_use_time(50),"gekokujo_yumi_1","bo_pw_weapon", spr_change_troop_triggers("trp_horse_archer", cost=5000, after_respawn=True, use_string="str_troop_become_for")),
  ("pws_change_troop_samurai_horse_archer",spr_use_time(50),"gekokujo_yumi_1","bo_pw_weapon", spr_change_troop_triggers("trp_samurai_horse_archer", cost=10000, after_respawn=True, use_string="str_troop_become_for")),
  ("pws_change_troop_elephant_master",spr_use_time(50),"spiked_club","bo_pw_weapon", spr_change_troop_triggers("trp_elephant_master", cost=15000, after_respawn=True, use_string="str_troop_become_for")),
  #SHOGUN MOD END - RAMARAUNT
  
  #1.6 add
  # from 'gekokujo_items.brf': begin (OpenBRF)
	( "pws_item_white_rice_sack"                            ,0,"white_rice_sack","bo_white_rice_sack",[]),
	( "pws_item_soybean_sack"                               ,0,"soybean_sack","bo_soybean_sack",[]),
	( "pws_item_rice"                                       ,0,"rice",0,[]),
	( "pws_item_mushroom_basket"                            ,0,"mushroom_basket","bo_mushroom_basket",[]),
	
	( "pws_code_rice_field_plants"                          ,0,"rice_field_plants",0,spr_field_plant_triggers(seeds=4, water=2)),
	  ("pws_rice_paddy",spr_field_flags(),"rice_field","bo_pw_wheat_field", spr_hit_field_triggers(resource_item="itm_rice_bag", plant_item="itm_sowing_rice", plant_spr="spr_pws_code_rice_field_plants", height=180, full_hp=2000, resource_hp=50, tool_class=item_class_grain_harvesting, regrow_interval=600)),

	  ("pws_process_rice",spr_use_time(5),"table_small_b","bo_table_small_b", spr_process_resource_triggers("script_cf_process_rice", use_string="str_process_rice")),
	  
	    ("pws_buy_sowing_rice",spr_buy_item_flags(1),"white_rice_sack","bo_white_rice_sack", spr_buy_item_triggers("itm_sowing_rice", pos_offset=(0,10,-20), resources=["itm_rice_bag"])),
		
		("pws_import_rice_bag",spr_use_time(30),"mill_flour_sack_desk_a","bo_mill_flour_sack_desk_a_fixed", spr_import_item_triggers("itm_rice_bag", pos_offset=(0,10,-20), price_multiplier=3000)),
		
		 ("pws_stockpile_rice_bag",spr_use_time(1),"mill_flour_sack_desk_a","bo_mill_flour_sack_desk_a_fixed", spr_stockpile_resource_triggers("itm_rice_bag")),

	  # from 'gekokujo_items.brf': begin (OpenBRF)
# from 'gekokujo_items.brf': end (OpenBRF)

# from 'gekokujo_items.brf': end (OpenBRF)

  #1.7
  ("pws_harvest_good_mushrooms",spr_field_flags()|spr_use_time(1),"shrooms","bo_shrooms", spr_use_plant_triggers("itm_shitocky_mushroom", full_hp=200, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  
  ("pws_harvest_bad_mushrooms",spr_field_flags()|spr_use_time(1),"shrooms","bo_shrooms", spr_use_plant_triggers("itm_bad_trip_mushroom", full_hp=200, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  
  ("pws_harvest_truffle",spr_field_flags()|spr_use_time(1),"truffle","bo_truffle", spr_use_plant_triggers("itm_truffle", full_hp=200, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  
  ("pws_harvest_dotted_mushrooms",spr_field_flags()|spr_use_time(1),"copy_shrooms","bo_copy_shrooms", spr_use_plant_triggers("itm_dotted_mushroom", full_hp=200, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  
  ("pws_stockpile_truffle",spr_use_time(1),"mushroom_basket","bo_mushroom_basket", spr_stockpile_resource_triggers("itm_truffle")),
  ("pws_stockpile_shitocky_mushroom",spr_use_time(1),"mushroom_basket","bo_mushroom_basket", spr_stockpile_resource_triggers("itm_shitocky_mushroom")),
  
  #1.8
  ("pws_stockpile_sushi",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_sushi")),
  
  #1.9
  ( "big_rice_wine_barrel"                       ,0,"big_rice_wine_barrel","bo_big_rice_wine_barrel",[]),
  
  ("pws_stockpile_rice_wine",spr_use_time(1),"rice_wine_barrel","bo_rice_wine_barrel", spr_stockpile_resource_triggers("itm_rice_wine_barrel")),
  
  #1.10
  ("pws_harvest_carrot",spr_field_flags()|spr_use_time(1),"carrot_farm","bo_carrot_farm", spr_use_plant_triggers("itm_carrot", full_hp=50, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  
  ("pws_harvest_cabbage",spr_field_flags()|spr_use_time(1),"cabbage_b","bo_cabbage_b", spr_use_plant_triggers("itm_cabbage", full_hp=50, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  
  ("pws_harvest_potato",spr_field_flags()|spr_use_time(1),"big_bush","bo_cabbage_b", spr_use_plant_triggers("itm_potato", full_hp=50, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  
  ("pws_stockpile_carrot",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_carrot")),
  ("pws_stockpile_cabbage",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_cabbage")),
  ("pws_stockpile_potato",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_potato")),
  
  ("pws_process_cow",spr_use_time(5),"pw_cow","bo_pw_cow", spr_cow_triggers()),
  ("pws_process_churn",spr_use_time(5),"churn","bo_churn", spr_process_resource_triggers("script_cf_process_churn", use_string="str_process_butter")),
  ("pws_stockpile_butter",spr_use_time(1),"butter_pot","bo_butter_pot", spr_stockpile_resource_triggers("itm_butter_small")),
  
  #1.11
  
  ("pws_harvest_karashi_seed",spr_field_flags()|spr_use_time(1),"yellow_flower","bo_cabbage_b", spr_use_plant_triggers("itm_karashi_seeds", full_hp=50, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  ("pws_stockpile_karashi_mustard",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_karashi_mustard")),
  
  ("pws_harvest_soybean",spr_field_flags()|spr_use_time(1),"seedy_plant_a","bo_cabbage_b", spr_use_plant_triggers("itm_soybeans", full_hp=50, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  ("pws_stockpile_soybean",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_soybeans")),
  ("pws_stockpile_soybean_sauce",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_soybean_sauce")),
  
  ("pws_harvest_welsh_onion",spr_field_flags()|spr_use_time(1),"small_plant","bo_cabbage_b", spr_use_plant_triggers("itm_onion", full_hp=50, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  ("pws_stockpile_onions",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_onion")),
  
  ("pws_stockpile_cheese",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_cheese")),
  
  ("pws_harvest_tea_leaves",spr_field_flags()|spr_use_time(1),"common_plant","bo_cabbage_b", spr_use_plant_triggers("itm_tea_herb", full_hp=50, resource_hp=50, regrow_interval=300, sound="snd_pull_flax")),
  ("pws_stockpile_tea_leaves",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_tea_herb")),
  
  #1.11.1
  # from 'gekokujo_items.brf': begin (OpenBRF)
	( "pws_tree_japan_maple"                                    ,0,"arvore_","bo_arvore_",[]),
	("pws_tree_japan_maple_cutable",spr_tree_flags(),"arvore_","bo_arvore_", spr_tree_triggers(full_hp=1500, fell_hp=600)),
	
		( "pws_tree_birch_a"                                    ,0,"birch_01","bo_birch_01",[]),
	( "pws_tree_birch_a_cutable"                                    ,spr_tree_flags(),"birch_01","bo_birch_01",spr_tree_triggers(full_hp=1500, fell_hp=700)),
	
		( "pws_tree_birch_b"                                    ,0,"birch_02","bo_birch_02",[]),
	( "pws_tree_birch_b_cutable"                                    ,spr_tree_flags(),"birch_02","bo_birch_02",spr_tree_triggers(full_hp=1500, fell_hp=700)),
	
		( "pws_tree_birch_c"                                    ,0,"birch_03","bo_birch_03",[]),
	( "pws_tree_birch_c_cutable"                                    ,spr_tree_flags(),"birch_03","bo_birch_03",spr_tree_triggers(full_hp=1500, fell_hp=700)),
# from 'gekokujo_items.brf': end (OpenBRF)

("pws_stockpile_rice_flour",spr_use_time(1),"box_a","bo_box_a", spr_stockpile_resource_triggers("itm_rice_flour")),

#1.11.4
( "pws_bamboo"                                    ,0,"bamboo",0,[]),
( "pws_tropical_leaves"                                    ,0,"tropicleaf",0,[]),
( "pws_palm_plant"                                    ,0,"palm_plant",0,[]),
		( "pws_tree_fir_lowpoly"                                    ,0,"fir","bo_fir",[]),
	( "pws_tree_fir_lowpoly_cutable"                                    ,spr_tree_flags(),"fir","bo_fir",spr_tree_triggers(full_hp=1500, fell_hp=700)),
	
			( "pws_tree_cherry"                                    ,0,"pinktree","bo_pinktree",[]),
	( "pws_tree_cherry_cutable"                                    ,spr_tree_flags(),"pinktree","bo_pinktree",spr_tree_triggers(full_hp=1500, fell_hp=700)),
	#1.11.5
	( "pws_water_square"                                    ,0,"pws_water_square",0,[]),
	( "pws_water_triangle"                                    ,0,"pws_water_triangle",0,[]),
	( "pws_castle_faction_interest_ledger"                                    ,0,"book_open.9","bo_book_open",[(ti_on_scene_prop_use, [])]),
	( "pws_ladysun"                                    ,0,"ladysun",0,[]),
	
	#1.17
	("pws_buy_plague_mask",spr_buy_item_flags(2),"mask","bo_pw_armor_head", spr_buy_item_triggers("itm_plague_mask", resources=["itm_healing_herb","itm_iron_bar_short","itm_linen_cloth","itm_leather_roll"], tailoring=5)),

	#1.24
	("pws_code_ice_stuck",0,"ice_stuck","bo_ice_stuck",[]),
	("pws_buy_kitsune_glaive",spr_buy_item_flags(9),"kitsune_glaive","bo_pw_weapon_big", spr_buy_item_triggers("itm_kitsune_glaive", resources=["itm_wood_pole", "itm_iron_bar"], engineer=3)),
	("pws_buy_gilded_cutlass",spr_buy_item_flags(9),"gilded_scabbard","bo_pw_weapon_big", spr_buy_item_triggers("itm_sebastian_sword", resources=["itm_wood_pole", "itm_iron_bar", "itm_gold_nugget"], engineer=3)),
	]
