  ...
  ("money_bag", prsntf_manual_end_only, 0, # allows dropping money bags on the ground, and depositing to or withdrawing from nearby money chests
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
	  ...
	  (create_button_overlay, "$g_presentation_obj_money_drop_twenty", "str_drop_twenty"),#RAMARAUNT ADD
      (overlay_set_color, "$g_presentation_obj_money_drop_twenty", 0xFFFFFF),
      (position_set_x, pos1, 280),
      (position_set_y, pos1, 344),
      (overlay_set_position, "$g_presentation_obj_money_drop_twenty", pos1),
      (overlay_set_size, "$g_presentation_obj_money_drop_twenty", pos2),
