...
scripts.extend([
  ...
  ("game_get_use_string", # clients: called by the game when the local player is aiming at a usable scene prop
   [(store_script_param, ":instance_id", 1),
	...
	(else_try), #RAMARAUNT ADD for ledger
		(prop_instance_get_scene_prop_kind, ":scene_prop_id", ":instance_id"),
		(eq, ":scene_prop_id", "spr_pws_castle_faction_interest_ledger"),
		(call_script, "script_scene_prop_ledger_get_money", ":instance_id"),
		(assign, reg45, reg0),
		(assign, reg46, reg1),
		(call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
		(str_store_faction_name, s11, reg0),
		(call_script, "script_return_money_chest_last_user_string", reg0),
		(str_store_string, s0, "str_interest_ledger_string"),
   ...
   [(store_script_param, ":sender_player_id", 1),
    ...
    (try_begin), # section of events received by clients from the server
      ...
      (else_try), # play a sound at the location of a scene prop
        ...
        (try_end),
	  (else_try), # hear someone vomit RAMARAUNT ADD
        (eq, ":event_type", server_event_player_has_vomited),
        (store_script_param, ":player_id", 3),
		(try_begin),
			(eq, ":player_id", -1),
			(display_message, "str_you_vomit", lockpicking_success_color),
		(else_try),
			(str_store_player_username, s1, ":player_id"),
			(str_store_string, s2, "str_he_vomit"),
			(display_message, s2, lockpicking_success_color),		
		(try_end),
	  (else_try), # hear someone cough RAMARAUNT ADD
        (eq, ":event_type", server_event_player_has_coughed),
        (store_script_param, ":player_id", 3),
		(try_begin),
			(eq, ":player_id", -1),
			(display_message, "str_you_cough", lockpicking_success_color),
		(else_try),
			(str_store_player_username, s1, ":player_id"),
			(str_store_string, s2, "str_he_cough"),
			(display_message, s2, lockpicking_success_color),		
		(try_end),
	  (else_try), # illness update RAMARAUNT ADD
		(eq, ":event_type", server_event_illness_update),
		(store_script_param, ":illness_id", 3),
		(store_script_param, ":progression", 4),
		
		(try_begin),
			(eq, ":illness_id", 1), #cold
			(try_begin),
				(eq, ":progression", 25),
				(display_message, "str_slightly_sick", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 75),
				(display_message, "str_very_sick", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 74),
				(display_message, "str_starting_to_feel_better", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 1),
				(display_message, "str_not_sick_anymore", lockpicking_success_color),
			(try_end),
		(else_try),
			(eq, ":illness_id", 2), #flu
			(try_begin),
				(eq, ":progression", 25),
				(display_message, "str_flu_begin", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 50),
				(display_message, "str_flu_ache", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 75),
				(display_message, "str_flu_pain", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 49),
				(display_message, "str_flu_better_stomach", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 24),
				(display_message, "str_flu_almost_gone", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 1),
				(display_message, "str_flu_gone", lockpicking_success_color),
			(try_end),
		(else_try),
			(eq, ":illness_id", 3), #plague
			(try_begin),
				(eq, ":progression", 25),
				(display_message, "str_plague_slight_rash", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 50),
				(display_message, "str_plague_vomiting", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 75),
				(display_message, "str_plague_agony", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 49),
				(display_message, "str_plague_stomach_better", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 24),
				(display_message, "str_plague_turning_around", lockpicking_success_color),
			(else_try),
				(eq, ":progression", 1),
				(display_message, "str_plague_cured", lockpicking_success_color),
			(try_end),
		(try_end),
	  
	  (else_try), #plague death event
		(eq, ":event_type", server_event_died_from_illness),
		(store_script_param, ":player_id_death", 3),
		(str_store_player_username, s0, ":player_id_death"),
		(display_message, "str_global_ck_plague", lockpicking_success_color),
	  (else_try), #necromancer messages (all handled here)
		(eq, ":event_type", server_event_necromancer_message),
		(store_script_param, ":action", 3),
		(try_begin),
			(eq, ":action", 0),
			(display_message, "str_necro_book_page_turned_one", lockpicking_success_color),
		(else_try),
			(eq, ":action", 1),
			(display_message, "str_necro_book_page_turned_two", lockpicking_success_color),
		(else_try),
			(eq, ":action", 2),
			(display_message, "str_necro_state_peaceful", lockpicking_success_color),
		(else_try),
			(eq, ":action", 3),
			(display_message, "str_necro_state_faction", lockpicking_success_color),
		(else_try),
			(eq, ":action", 4),
			(display_message, "str_necro_state_allies", lockpicking_success_color),
		(else_try),
			(eq, ":action", 5),
			(display_message, "str_necro_state_allies_commoner", lockpicking_success_color),
		(else_try),
			(eq, ":action", 6),
			(display_message, "str_necro_state_allies_commoner_outlaw", lockpicking_success_color),
		(else_try),
			(eq, ":action", 7),
			(display_message, "str_necro_state_noone", lockpicking_success_color),
		(else_try),
			(eq, ":action", 8),
			(display_message, "str_necro_state_ffa", lockpicking_success_color),
		(try_end),
	  ...
	  (else_try), # display lockpicking message RAMARAUNT ADD
        (eq, ":event_type", server_event_lockpick),
		(store_script_param, ":fail", 3),
		(try_begin),
			(eq, ":fail", 0),
			(display_message, "str_pick_fail", lockpicking_fail_color),
		(else_try),
		    (eq, ":fail", 1),
			(display_message, "str_pick_success", lockpicking_success_color),
		(try_end),
	  (else_try), 
	        (eq, ":event_type", server_event_drunk_drink),
			(store_script_param, ":drunkeness", 3),
			(display_message, "str_drink_swig"),
			(try_begin),
				(ge, ":drunkeness", 90),
				(display_message, "str_drink_dazed"),
			(else_try),
				(ge, ":drunkeness", 75),
				(display_message, "str_drink_sick"),
			(else_try),
				(ge, ":drunkeness", 60),
				(display_message, "str_drink_wobbly"),
			(else_try),
				(ge, ":drunkeness", 30),
				(display_message, "str_drink_tipsy"),
			(else_try),
				(display_message, "str_drink_fine"),
			(try_end),
	  (else_try),
			(eq, ":event_type", server_event_drunk_update_client),
			(store_script_param, ":drunkeness", 3),
			(try_begin),
				(eq, ":drunkeness", 89),
				(display_message, "str_drink_sick"),
			...
			(else_try),
				(eq, ":drunkeness", 0),
				(display_message, "str_drink_sober"),
			(try_end),
  ...
  ("game_get_item_extra_text", # called by the game when the show_item_details operation is called. set_result_string is for the text displayed, set_trigger result for the color
   [(store_script_param, ":item_id", 1),
	...
	(try_begin), #RAMARAUNT ADD
		(eq, ":item_id", "itm_plague_mask"),
		(set_result_string, "str_item_plague_mask"),
	(try_end),
    ]),
  ...
  ("initialize_game_rules", # set module default settings before loading the server configuration
   [
	...
	(assign, "$g_zombie_count", 0), #ramaraunt add
	(assign, "$g_golem_count", 0), #ramaraunt add
	(assign, "$g_cur_iceball", 1), #ramaraunt add
	...
	(troop_set_slot, "trp_farmer", slot_troop_ranking, 0), #RAMARAUNT ADD
    (troop_set_slot, "trp_levy", slot_troop_ranking, 2),
    (troop_set_slot, "trp_hunter", slot_troop_ranking, 4),
    (troop_set_slot, "trp_tailor", slot_troop_ranking, 6),
    (troop_set_slot, "trp_shepherd", slot_troop_ranking, 9),
    (troop_set_slot, "trp_explorer", slot_troop_ranking, 10),
    (troop_set_slot, "trp_thug", slot_troop_ranking, 12),
    (troop_set_slot, "trp_thief", slot_troop_ranking, 14),
    (troop_set_slot, "trp_retainer", slot_troop_ranking, 20),
    (troop_set_slot, "trp_bow_master", slot_troop_ranking, 21),
	(troop_set_slot, "trp_horse_archer", slot_troop_ranking, 21),
	(troop_set_slot, "trp_samurai_horse_archer", slot_troop_ranking, 21),
	(troop_set_slot, "trp_ninja", slot_troop_ranking, 21),
	(troop_set_slot, "trp_elephant_master", slot_troop_ranking, 21),
    (troop_set_slot, "trp_sharpshooter", slot_troop_ranking, 22),
    (troop_set_slot, "trp_outrider", slot_troop_ranking, 23),
    (troop_set_slot, "trp_funanori", slot_troop_ranking, 24),
    (troop_set_slot, "trp_architect", slot_troop_ranking, 30),
    (troop_set_slot, "trp_physician", slot_troop_ranking, 35),
    (troop_set_slot, "trp_blacksmith", slot_troop_ranking, 36),
    (troop_set_slot, "trp_samauri", slot_troop_ranking, 40),
    (troop_set_slot, "trp_lancer", slot_troop_ranking, 41),
	(troop_set_slot, "trp_farmer", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_levy", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_hunter", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_tailor", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_shepherd", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_explorer", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_thug", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_thief", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_retainer",slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_bow_master", slot_troop_spawn_health_percent, 50),
	(troop_set_slot, "trp_horse_archer", slot_troop_spawn_health_percent, 50),
	(troop_set_slot, "trp_samurai_horse_archer", slot_troop_spawn_health_percent, 50),
	(troop_set_slot, "trp_ninja", slot_troop_spawn_health_percent, 50),
	(troop_set_slot, "trp_elephant_master", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_sharpshooter", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_outrider", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_funanori", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_architect", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_physician", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_blacksmith", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_samauri", slot_troop_spawn_health_percent, 50),
    (troop_set_slot, "trp_lancer", slot_troop_spawn_health_percent, 50),
    (assign, "$g_extra_item_details_1_string_id", -1),
    (assign, "$g_extra_item_details_2_string_id", -1),
  ...
  ("initialize_scene_globals", # reset global values to initial values when starting a mission
   [
	...
	#ramaraunt add
	(str_store_string, s50, "str_noone"),
	(str_store_string, s51, "str_noone"),
	(str_store_string, s52, "str_noone"),
	(str_store_string, s53, "str_noone"),
	(str_store_string, s54, "str_noone"),
	(str_store_string, s55, "str_noone"),
	(str_store_string, s56, "str_noone"),
	(str_store_string, s57, "str_noone"),
	(str_store_string, s58, "str_noone"),
    ]),
  ...
  ("on_agent_spawned", # server and clients: set agent slots and attributes after spawning
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (else_try),
	  		#ramaraunt add initial food
		(agent_set_slot, ":agent_id", slot_agent_food_amount, 50),
      (try_end),
      (try_begin),
        (player_is_admin, ":player_id"),
        (player_get_troop_id, ":troop_id", ":player_id"),
  ...
  ("setup_player_joined", # server: when a player connects, update necessary data on clients, restore data from previous play sessions in this mission, and set up other attributes
   [(store_script_param, ":player_id", 1), # must be valid
	...
	(call_script, "script_reset_illnesses", ":player_id"), #RAMARAUNT ADD
	...
	(player_set_slot, ":player_id", slot_player_food_tick, 0), #RAMARAUNT set food ticks to 0
  ...
  ("plague_death_calculate",
  [(store_script_param_1, ":dead_player_id"),
  
  (try_begin),
	(player_is_active, ":dead_player_id"),
	(neg|player_slot_eq,":dead_player_id",slot_player_plague_direction,-1),
	(try_for_agents, ":other_agent_id"),
		(agent_get_player_id, ":other_player_id", ":other_agent_id"),
		(multiplayer_send_int_to_player, ":other_player_id", server_event_died_from_illness, ":dead_player_id"),
	(try_end),
  (try_end),
  ...
  ("apply_consequences_for_agent_death", # server and clients: when an agent dies, adjust scores, display messages, drop a loot money bag, check outlaw rating
   [(store_script_param, ":dead_agent_id", 1),
    ...
    (try_begin),
      ...
      (player_is_active, ":dead_player_id"),
	  #(call_script, "script_check_if_dead_from_plague", ":dead_player_id"),
      (try_begin),
...
scripts.extend([
  ...
  ("setup_castle_money_chests", # check for linked money chests for each castle, caching the instance ids
   [
    ...
    (try_end),
	(try_for_range, ":interest_slot", slot_mission_data_interest_box_begin,slot_mission_data_interest_box_end), #RAMARAUNT ADD TRY LOOP
	  (troop_set_slot, "trp_mission_data", ":interest_slot", 0),
	(try_end),
    (try_begin),
      (neq, "$g_game_type", "mt_no_money"),
      (scene_prop_get_num_instances, ":chest_num", "spr_pw_castle_money_chest"),
	  (scene_prop_get_num_instances, ":ledger_num", "spr_pws_castle_faction_interest_ledger"),
      (try_for_range, ":chest_no", 0, ":chest_num"),
        (scene_prop_get_instance, ":instance_id", "spr_pw_castle_money_chest", ":chest_no"),
		(scene_prop_set_slot, ":instance_id", slot_money_chest_interest_timer, 0),		
        (call_script, "script_scene_prop_get_owning_faction", ":instance_id"),
		(assign, ":chest_fac", reg1),
        (is_between, ":chest_fac", slot_mission_data_castle_owner_faction_begin, slot_mission_data_castle_owner_faction_end),
        (store_add, ":chest_slot", ":chest_fac", slot_mission_data_castle_money_chest_begin),
        #(troop_slot_eq, "trp_mission_data", ":chest_slot", 0),
        (troop_set_slot, "trp_mission_data", ":chest_slot", ":instance_id"),
		(try_for_range, ":ledger_no", 0, ":ledger_num"), #RAMARAUNT LEDGERS ADD
			(scene_prop_get_instance, ":ledger_id", "spr_pws_castle_faction_interest_ledger", ":ledger_no"),
			(call_script, "script_scene_prop_get_owning_faction", ":ledger_id"),
			(eq, ":chest_fac", reg1),
			(store_add, ":ledger_slot", reg1, slot_mission_data_interest_box_begin),
			#(troop_slot_eq, "trp_mission_data", ":ledger_slot", 0),
			(troop_set_slot, "trp_mission_data", ":ledger_slot", ":ledger_id"),
		(try_end),
      (try_end),
    (try_end),
    ]),
  ...
  ("castle_receive_gold", # server: send money directly into the castle's linked chest
   [(store_script_param, ":castle_slot", 1),
    ...
    (try_begin),
	  ...
	  (assign, ":fac_no", ":castle_slot"),
      (val_add, ":castle_slot", slot_mission_data_castle_money_chest_begin),
      (troop_get_slot, ":instance_id", "trp_mission_data", ":castle_slot"),
      (gt, ":instance_id", 0),
	  (store_add, ":ledger_slot", ":fac_no", slot_mission_data_interest_box_begin),
	  (troop_get_slot, ":ledger_id", "trp_mission_data", ":ledger_slot"),
	  (neq, ":ledger_id", 0),
      (scene_prop_get_slot, ":chest_gold", ":instance_id", slot_scene_prop_stock_count),
	  (call_script, "script_scene_prop_ledger_get_money", ":ledger_id"),
	  (ge, ":chest_gold", reg0),
      (try_begin),
        (gt, ":percentage", -1),
  ...
  ("castle_recieve_taxes", #Ramaraunt script: this script is called for each chest every 30 seconds.
 [(try_for_range, ":fac_no", 0, 9),
	(store_add, ":chest_slot", slot_mission_data_castle_money_chest_begin, ":fac_no"),
	(store_add, ":ledger_slot", slot_mission_data_interest_box_begin, ":fac_no"),
	(troop_get_slot, ":chest_id", "trp_mission_data", ":chest_slot"),
	(troop_get_slot, ":ledger_id", "trp_mission_data", ":ledger_slot"),
	(scene_prop_get_slot, ":chest_gold", ":chest_id", slot_scene_prop_stock_count),
	(call_script, "script_scene_prop_ledger_get_money", ":ledger_id"),
	(try_begin),
		(ge, ":chest_gold", reg0),
		(le, ":chest_gold", reg2),
		(scene_prop_get_slot, ":timer", ":chest_id", slot_money_chest_interest_timer),
		(try_begin),
			(ge, ":timer", 20),
			(scene_prop_set_slot, ":chest_id", slot_money_chest_interest_timer, 0),
			(neq, ":ledger_id", 0),
			(val_add, ":chest_gold", reg1),
			(scene_prop_set_slot, ":chest_id", slot_scene_prop_stock_count, ":chest_gold"),
		(else_try),
			(val_add, ":timer", 1),
			(scene_prop_set_slot, ":chest_id", slot_money_chest_interest_timer, ":timer"),
		(try_end),
	(else_try),
		(scene_prop_set_slot, ":chest_id", slot_money_chest_interest_timer, 0),
	(try_end),
  ...
  ("scene_prop_ledger_get_money", # get the amount of gold from the ledger and store it in reg0 and reg1 RAMARAUNT ADD
   [(store_script_param, ":instance_id", 1), # must be valid

    (prop_instance_get_variation_id_2, ":scene_prop_ledger_amount", ":instance_id"),
	(val_mul, ":scene_prop_ledger_amount", 10000),
	(assign, reg0, ":scene_prop_ledger_amount"),
	(val_div, ":scene_prop_ledger_amount", 100),
	(val_mul, ":scene_prop_ledger_amount", 5),
	(assign, reg1, ":scene_prop_ledger_amount"),	

	(store_add, reg2, reg0, 100000),
    ]),
  ...
  ("cf_use_castle_money_chest", # server and clients: handle depositing to and withdrawing from a money chest. the client version just does the checks, the server version also applies changes
   [(store_script_param, ":player_id", 1), # must be valid
	...
	#RAMARAUNT ADD LEDGER KEEPING TRACK OF LAST USER
	(call_script, "script_store_money_chest_last_user", ":player_id", ":instance_id"),
    ]),

	("store_money_chest_last_user", #RAMARAUNT SCRIPT
	...
	(try_begin),
		(eq, reg0, 0),
		(str_store_player_username, s50, ":player_id"),
		
	(else_try),
		(eq, reg0, 1),
		(str_store_player_username, s51, ":player_id"),
	(else_try),
		(eq, reg0, 2),
		(str_store_player_username, s52, ":player_id"),
	(else_try),
		(eq, reg0, 3),
		(str_store_player_username, s53, ":player_id"),
	(else_try),
		(eq, reg0, 4),
		(str_store_player_username, s54, ":player_id"),
	(else_try),
		(eq, reg0, 5),
	...
	(else_try),
		(eq, reg0, 7),
		(str_store_player_username, s57, ":player_id"),
	(else_try),
		(eq, reg0, 8),
		(str_store_player_username, s58, ":player_id"),
	(try_end),
	
	
	]),
	
	("return_money_chest_last_user_string", #RAMARAUNT SCRIPT
	[(store_script_param_1, ":fac_no"),
	
	(try_begin),
		(eq, ":fac_no", 0),
		(str_store_string, s49, s50),
	(else_try),
		(eq, ":fac_no", 1),
		(str_store_string, s49, s51),
	(else_try),
		(eq, ":fac_no", 2),
		(str_store_string, s49, s52),
	(else_try),
		(eq, ":fac_no", 3),
		(str_store_string, s49, s53),
	(else_try),
		(eq, ":fac_no", 4),
		(str_store_string, s49, s54),
	(else_try),
		(eq, ":fac_no", 5),
		(str_store_string, s49, s55),
	(else_try),
		(eq, ":fac_no", 6),
		(str_store_string, s49, s56),
	(else_try),
		(eq, ":fac_no", 7),
		(str_store_string, s49, s57),
	(else_try),
		(eq, ":fac_no", 8),
		(str_store_string, s49, s58),
	(try_end),
  ...
  ("check_on_item_picked_up", # server: extra checks when an agent picks up an item
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try),
	  ...
	  (this_or_next|eq, ":item_id", "itm_zombie_sword"),
	  (this_or_next|eq, ":item_id", "itm_evil_arrows"),
	  (this_or_next|eq, ":item_id", "itm_evil_katana"),
	  (this_or_next|eq, ":item_id", "itm_evil_yumi"),
	  (this_or_next|eq, ":item_id", "itm_skeleton_cleaver"),
	  (this_or_next|eq, ":item_id", "itm_skeleton_bow"),
	  (this_or_next|eq, ":item_id", "itm_skeleton_arrows"),
	  (this_or_next|eq, ":item_id", "itm_skeleton_dagger"),
	  (this_or_next|eq, ":item_id", "itm_rockball"),
	  (this_or_next|eq, ":item_id", "itm_rockball_golem"),
	  (this_or_next|eq, ":item_id", "itm_fireball"),
	  (this_or_next|eq, ":item_id", "itm_oni_axe"),
	  (this_or_next|eq, ":item_id", "itm_rock_sword"),
  ...
  ("check_on_item_dropped", # server: extra checks when an agent drops an item
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try), # remove admin items dropped on the ground
	  ...
	  (this_or_next|eq, ":item_id", "itm_zombie_sword"), #Ramaraunt add
	  (this_or_next|eq, ":item_id", "itm_evil_arrows"),
	  (this_or_next|eq, ":item_id", "itm_evil_yumi"),
	  (this_or_next|eq, ":item_id", "itm_evil_katana"),
	  (this_or_next|eq, ":item_id", "itm_necro_bomb"),
	  (this_or_next|eq, ":item_id", "itm_skeleton_cleaver"),
	  (this_or_next|eq, ":item_id", "itm_skeleton_bow"),
	  (this_or_next|eq, ":item_id", "itm_skeleton_arrows"),
	  (this_or_next|eq, ":item_id", "itm_oni_axe"),
  ...
  ("setup_ice_balls",[ #Ramaraunt add
  	#ramaraunt add iceballs
	(prop_instance_get_position, pos2, 1),
	(position_set_x, 0, pos2),
	(position_set_y, 0, pos2),
	(position_set_z, 0, pos2),
	(try_for_range,":ran", 1,11),
		(set_spawn_position, pos2),
		(spawn_scene_prop, "spr_pws_code_ice_stuck"),
		(scene_prop_get_instance, ":cur_ice", "spr_pws_code_ice_stuck", ":ran"),
		(call_script, "script_remove_scene_prop", ":cur_ice"),
	(try_end),
  ]),
  
  ("cf_move_ice_ball",[
  (scene_prop_get_instance, ":cur_ice", "spr_pws_code_ice_stuck", "$g_cur_iceball"),
  (try_begin),
	(scene_prop_slot_eq, ":cur_ice", slot_scene_prop_state, scene_prop_state_hidden),
	(prop_instance_enable_physics, ":cur_ice", 1),
  (try_end),
  (prop_instance_set_position, ":cur_ice", pos1),
  (try_begin),
	(eq, "$g_cur_iceball", 10),
	(assign, "$g_cur_iceball", 1),
  (else_try),
	(val_add, "$g_cur_iceball", 1),
  (try_end),
  ]),
  ...
  ("cf_agent_pick_lock", # server: calculate whether an agent picks a lock successfully, based on skill, tool, and random chance
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      (ge, ":random", ":looting"),
      #(agent_play_sound, ":agent_id", "snd_pick_lock_fail"),RAMARAUNT
	  (agent_get_player_id, ":player_id", ":agent_id"),
	  (multiplayer_send_int_to_player, ":player_id", server_event_lockpick, 0),
    (try_end),
    (lt, ":random", ":looting"),
	(agent_get_player_id, ":player_id", ":agent_id"),
	(multiplayer_send_int_to_player, ":player_id", server_event_lockpick, 1),
    ]),
...
scripts.extend([
  ...
  ("cf_process_grind", #RAMARAUNT EDIT FOR RICE FLOUR
   [generate_process_init(skill="skl_labouring", level=1, resource_class=item_class_food),
    ...
    (try_begin),
      ...
      (try_end),
	(else_try),
	  (eq, ":resource_item_id", "itm_rice_bag"),
      (assign, ":processed_item_id", "itm_rice_flour"),
    (try_end),
    (neq, ":processed_item_id", -1),
    (try_begin),
      (eq, ":finished", 1),
  ...
  ("cf_process_cook", #ALTERED BY RAMARAUNT
   [generate_process_init(skill="skl_labouring", level=1, resource_class=item_class_food),
	...
	(else_try), #mushroom soup
		(eq, ":resource_item_id", "itm_shitocky_mushroom"),
		(assign, ":processed_item_id", "itm_shitocky_soup"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
	(else_try), #bad mushroom soupo
		(eq, ":resource_item_id", "itm_bad_trip_mushroom"),
		(assign, ":processed_item_id", "itm_shit_soup"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
	(else_try), #vegetable soup
		(this_or_next|eq, ":resource_item_id", "itm_cut_carrots"),
		(this_or_next|eq, ":resource_item_id", "itm_cut_potato"),
		(eq, ":resource_item_id", "itm_cabbage_leaf"),
		(assign, ":processed_item_id", "itm_vegetable_soup_pot"),
		(assign, ":resource_4_item_id", "itm_cabbage_leaf"),
		(assign, ":resource_3_item_id", "itm_cut_carrots"),
		(assign, ":resource_item_id", "itm_cut_potato"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
	(else_try), #stew
		(eq, ":resource_item_id", "itm_cut_meat"),
		(assign, ":processed_item_id", "itm_stew_pot"),
		(assign, ":resource_item_id", "itm_cut_meat"),
		(assign, ":resource_3_item_id", "itm_cut_carrots"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
		(assign, ":resource_4_item_id", "itm_cut_potato"),
	(else_try), #natto
		(eq, ":resource_item_id", "itm_soybeans"),
		(assign, ":processed_item_id", "itm_natto"),
		(assign, ":resource_3_item_id", "itm_karashi_mustard"),
		(assign, ":resource_2_item_id", "itm_cut_onions"),
	(else_try), #baked potato
		(eq, ":resource_item_id", "itm_potato"),
		(assign, ":processed_item_id", "itm_baked_potato"),
	(else_try), #rice bread
		(eq, ":resource_item_id", "itm_rice_flour"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
		(assign, ":processed_item_id", "itm_rice_bread"),
		(try_begin),
			(ge, ":skill_level", 5),
			(assign, ":processed_item_count", 5),
		(else_try),
		...
		(try_end),
	(else_try), #noodles
		(eq, ":resource_item_id", "itm_uncooked_noodles"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
		(assign, ":processed_item_id", "itm_noodles"),
		(assign, ":processed_item_count", 3),
	(else_try), #baked potato
		(eq, ":resource_item_id", "itm_teapot_unboiled"),
		(assign, ":processed_item_id", "itm_teapot"),
	(else_try), #mushroom stew poisinous
		(eq, ":resource_item_id", "itm_cut_mushrooms_poison"),
		(assign, ":processed_item_id", "itm_mushroom_stew_pot_poison"),
		(assign, ":resource_3_item_id", "itm_cut_carrots"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
		(assign, ":resource_4_item_id", "itm_cut_potato"),
	(else_try), # mushroom stew
		(eq, ":resource_item_id", "itm_cut_mushrooms"),
		(assign, ":processed_item_id", "itm_mushroom_stew_pot"),
		(assign, ":resource_3_item_id", "itm_cut_carrots"),
		(assign, ":resource_2_item_id", "itm_water_bucket"),
		(assign, ":resource_4_item_id", "itm_cut_potato"),
    (try_end),
  ...
  ("cf_process_press", #ALTERED BY RAMARAUNT FOR RICE WINE
   [generate_process_init(skill="skl_labouring", level=1, resource_class=item_class_food),
	...
	(else_try),
      (eq, ":resource_item_id", "itm_rice_bag"),
      (assign, ":processed_item_id", "itm_rice_wine_barrel"),
      (assign, ":resource_item_count",1),
    (try_end),
    (neq, ":processed_item_id", -1),
    (try_begin),
  ...
  ("cf_process_tavern", #ALTERED BY RAMARAUNT FOR RICE WINE
   [generate_process_init(resource_class=item_class_food, start_effect=False),
    ...
    (else_try), #SAKE ADD
      (eq, ":resource_item_id", "itm_rice_wine_barrel"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_rice_wine_jug"),
      (position_move_z, pos1, 120),
      (position_rotate_x, pos1, 90),
    (else_try),
      (eq, ":resource_item_id", "itm_rice_wine_jug"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_rice_wine_barrel"),
      (position_move_z, pos1, 116),
    (else_try), #vege soup add
      (eq, ":resource_item_id", "itm_vegetable_soup_pot"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_vegetable_soup_bowl"),
      (position_move_z, pos1, 105),
    (else_try),
      (eq, ":resource_item_id", "itm_vegetable_soup_bowl"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_vegetable_soup_pot"),
	  (position_move_z, pos1, 116),
	(else_try), #stew add
      (eq, ":resource_item_id", "itm_stew_pot"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_stew_bowl"),
	  (position_move_z, pos1, 116),
    (else_try),
      (eq, ":resource_item_id", "itm_stew_bowl"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_stew_pot"),
      (position_move_z, pos1, 116),
	(else_try), #Milk add
      (eq, ":resource_item_id", "itm_milk_bucket"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_milk_jug"),
      (position_move_z, pos1, 120),
      (position_rotate_x, pos1, 90),
	  (agent_equip_item, ":agent_id", "itm_bucket", 1),
	(else_try), #tea
      (eq, ":resource_item_id", "itm_teapot"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_cuppa_tea"),
	  (position_move_z, pos1, 116),
    (else_try),
      (eq, ":resource_item_id", "itm_cuppa_tea"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_teapot"),
      (position_move_z, pos1, 116),
	(else_try), #mushroom stew add
      (eq, ":resource_item_id", "itm_mushroom_stew_pot"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_mushroom_stew_bowl"),
	  (position_move_z, pos1, 116),
    (else_try),
      (eq, ":resource_item_id", "itm_mushroom_stew_bowl"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_mushroom_stew_pot"),
      (position_move_z, pos1, 116),
	(else_try), #mushroom stew poison add
      (eq, ":resource_item_id", "itm_mushroom_stew_pot_poison"),
      (assign, ":processed_item_count", 4),
      (assign, ":processed_item_id", "itm_mushroom_stew_bowl_poison"),
	  (position_move_z, pos1, 116),
    (else_try),
      (eq, ":resource_item_id", "itm_mushroom_stew_bowl_poison"),
      (assign, ":resource_item_count", 4),
      (assign, ":processed_item_id", "itm_mushroom_stew_pot_poison"),
      (position_move_z, pos1, 116),
    (try_end),
...
#RAMARAUNT SCRIPT
  ("cf_process_rice",
   [generate_process_init(skill="skl_labouring", level=1, resource_class=item_class_food, start_effect=False),
    ...
    (try_begin),
      (eq, ":resource_item_id", "itm_rice_bag"),
      (assign, ":processed_item_id", "itm_rice_bowl"),
	  (call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
	  (call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 3),
	(else_try),
		(eq, ":resource_item_id", "itm_fish"),
		(assign, ":processed_item_id", "itm_sushi"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_rice_bag", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_carrot"),
		(assign, ":processed_item_id", "itm_cut_carrots"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", "itm_cut_carrots", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_cabbage"),
		(assign, ":processed_item_id", "itm_cabbage_leaf"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", "itm_cabbage_leaf", 1),
	(else_try),
		(eq,":resource_item_id", "itm_potato"),
		(assign, ":processed_item_id", "itm_cut_potato"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", "itm_cut_potato", 1),
	(else_try),
		(this_or_next|eq, ":resource_item_id", "itm_salted_meat"),
		(this_or_next|eq, ":resource_item_id", "itm_raw_meat"),
		(eq, ":resource_item_id", "itm_cooked_meat"),
		(assign, ":processed_item_id", "itm_cut_meat"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", "itm_cut_meat", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_baked_potato"),
		(assign, ":processed_item_id", "itm_buttered_baked_potato"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_butter_small", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", "itm_buttered_baked_potato", 1),
	(else_try),
		(eq,":resource_item_id", "itm_bread"),
		(assign, ":processed_item_id", "itm_bread_cut"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 3),
	(else_try),
		(eq,":resource_item_id", "itm_onion"),
		(assign, ":processed_item_id", "itm_cut_onions"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq,":resource_item_id", "itm_bread_cut"),
		(assign, ":processed_item_id", "itm_buttered_bread_cut"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_butter_small", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_karashi_seeds"),
		(assign, ":processed_item_id", "itm_karashi_mustard"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_soybeans"),
		(assign, ":processed_item_id", "itm_soybean_sauce"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_soybean_sauce"),
		(assign, ":processed_item_id", "itm_rice_with_soy_sauce"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_rice_bowl", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_karashi_mustard"),
		(assign, ":processed_item_id", "itm_rice_with_karashi_mustard"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_rice_bowl", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_karashi_mustard"),
		(assign, ":processed_item_id", "itm_rice_with_karashi_mustard_and_soy_sauce"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_rice_with_soy_sauce", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_soybean_sauce"),
		(assign, ":processed_item_id", "itm_rice_with_karashi_mustard_and_soy_sauce"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_rice_with_karashi_mustard", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_rice_bread"),
		(assign, ":processed_item_id", "itm_rice_bread_cut"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 3),
	(else_try),
		(eq, ":resource_item_id", "itm_rice_bread_cut"),
		(assign, ":processed_item_id", "itm_rice_buttered_bread_cut"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_butter_small", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_flour_sack"),
		(assign, ":processed_item_id", "itm_uncooked_noodles"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_soybean_sauce"),
		(assign, ":processed_item_id", "itm_noodles_with_soy_sauce"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_noodles", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_karashi_mustard"),
		(assign, ":processed_item_id", "itm_noodles_with_mustard"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_rice_bowl", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_karashi_mustard"),
		(assign, ":processed_item_id", "itm_noodles_with_soy_sauce_and_mustard"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_noodles_with_soy_sauce", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_soybean_sauce"),
		(assign, ":processed_item_id", "itm_noodles_with_soy_sauce_and_mustard"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_karashi_mustard", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_tea_herb"),
		(assign, ":processed_item_id", "itm_teapot_unboiled"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", "itm_water_bucket", 1),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
		(agent_equip_item, ":agent_id", "itm_bucket", 1),
	(else_try),
		(eq,":resource_item_id", "itm_shitocky_mushroom"),
		(assign, ":processed_item_id", "itm_cut_mushrooms"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(else_try),
		(eq,":resource_item_id", "itm_bad_trip_mushroom"),
		(assign, ":processed_item_id", "itm_cut_mushrooms_poison"),
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(try_end),
   ...
   (try_begin),
      (eq, ":resource_item_id", "itm_milk_bucket"),
      (assign, ":processed_item_id", "itm_butter_small"),
	  (call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
	  (call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 2),
	  (agent_equip_item, ":agent_id", "itm_bucket", 1),
	(else_try),
		(eq, ":resource_item_id", "itm_butter_small"),
		(assign, ":processed_item_id", "itm_cheese"), 
		(call_script, "script_cf_agent_consume_item", ":agent_id", ":resource_item_id", 1),
		(call_script, "script_spawn_processed_resources", ":agent_id", ":processed_item_id", 1),
	(try_end),
	(neq, ":processed_item_id", -1),
  ...
  ("cf_pick_chest_lock", # server: handle players trying to pick the lock of a storage chest
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      #(agent_play_sound, ":agent_id", "snd_pick_lock_fail"), RAMARAUNT REMOVE FAIL SOUND
	  (multiplayer_send_int_to_player, ":player_id", server_event_lockpick, 0),
    (else_try),
      (call_script, "script_cf_agent_pick_lock", ":agent_id", ":probability_multiplier"),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_unlocked, 1),
	  (multiplayer_send_int_to_player, ":player_id", server_event_lockpick, 1), #RAMARAUNT ADD
      (assign, ":fail", 0),
    (else_try),
      (le, reg0, 0),
   ...
   [(store_script_param, ":attacked_agent_id", 1), # must be valid
    ...
    (else_try),
      ...
      (try_begin),
        ...
        (particle_system_burst, "psys_dummy_straw", pos1, 10),
      (try_end),
	(else_try), #ramaraunt add
		(this_or_next|eq, ":weapon_item_id", "itm_zombie_sword"),
		(this_or_next|eq, ":weapon_item_id", "itm_evil_arrows"),
		(this_or_next|eq, ":weapon_item_id", "itm_evil_yumi"),
	    (this_or_next|eq, ":weapon_item_id", "itm_skeleton_cleaver"),
	    (this_or_next|eq, ":weapon_item_id", "itm_skeleton_bow"),
	    (this_or_next|eq, ":weapon_item_id", "itm_skeleton_arrows"),
		(this_or_next|eq, ":weapon_item_id", "itm_skeleton_dagger"),
		(this_or_next|eq, ":weapon_item_id", "itm_necro_bomb"),
		(eq, ":weapon_item_id", "itm_evil_katana"),
		(try_begin),
			(agent_get_player_id, ":attacked_player_id", ":attacked_agent_id"),
			(player_is_active, ":attacked_player_id"),
			(player_set_slot, ":attacked_player_id", slot_player_zombie_infected, 1),
			(agent_get_slot, ":necromancer", ":attacker_agent_id", slot_player_zombie_necromancer),
			(try_begin),
				(neq, ":necromancer", -1),
				(player_set_slot, ":attacked_player_id", slot_player_zombie_necromancer,":necromancer"),
			(else_try),
				(agent_get_player_id, ":attacker_player_id", ":attacker_agent_id"),
				(player_set_slot, ":attacked_player_id", slot_player_zombie_necromancer,":attacker_player_id"),
		(try_end),
	(try_end),
    (try_end),
  ...
  ("cf_eat_food", # server: handle players consuming food items #ALTERED BY RAMARAUNT
   [(multiplayer_is_server),
    (store_script_param, ":agent_id", 1), # must be valid
    (store_script_param, ":item_id", 2),
	...
	(try_begin),
		...
		(player_is_active, ":player_id"),
		(multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_food_amount, ":food_amount"),
	(else_try),#ramaraunt add poison food
		(eq, ":food", 1),
	...
	(try_end),
	(try_begin),#Ramaraunt add stuff
		(eq, ":item_id", "itm_milk_bucket"),
		(agent_equip_item, ":agent_id", "itm_bucket"),
	(else_try),#drunkeness gained food
		(this_or_next|eq, ":item_id", "itm_beer_jug"),
		(this_or_next|eq, ":item_id", "itm_wine_jar"),
		(eq, ":item_id", "itm_rice_wine_jug"),
		(agent_get_player_id, ":player_id", ":agent_id"),
		(assign, ":drunkenadd", 20),
		(player_get_slot, ":drunkeness",":player_id", slot_player_drunkeness),
		(store_add, ":drunkentest", ":drunkeness", ":drunkenadd"),
		(try_begin),
			(gt, ":drunkentest", 100),
			(assign, ":drunkeness", 100),
		(else_try),
			(val_add, ":drunkeness", ":drunkenadd"),
		(try_end),
		(multiplayer_send_int_to_player, ":player_id", server_event_drunk_drink, ":drunkeness"),
		(player_set_slot, ":player_id", slot_player_drunkeness, ":drunkeness"),
	(else_try),#cold inducer
		(eq, ":item_id", "itm_cold_inducer"),
		(agent_get_player_id, ":player_id", ":agent_id"),
		(call_script, "script_cf_imbed_cold", ":player_id"),
	(else_try), #flu inducer
		(eq, ":item_id", "itm_flu_inducer"),
		(agent_get_player_id, ":player_id", ":agent_id"),
		(call_script, "script_cf_imbed_flu", ":player_id"),
	(else_try),
		(eq, ":item_id", "itm_plague_inducer"),
		(agent_get_player_id, ":player_id", ":agent_id"),
		(call_script, "script_cf_imbed_plague", ":player_id"),
	(else_try),#vomit
		(eq, ":item_id", "itm_vomit"),
		(agent_get_player_id, ":player_id", ":agent_id"),
		(store_random_in_range, ":rand", 0, 100),
		(gt, ":rand", 45),
		(call_script, "script_cf_catch_flu",":player_id"),		
	(else_try),#bloody vomit
		(eq, ":item_id", "itm_bloody_vomit"),
		(agent_get_player_id, ":player_id", ":agent_id"),
		(call_script, "script_cf_catch_plague",":player_id"),
	(else_try), #funny stuff
		(eq, ":item_id", "itm_funny_stuff"),
		(call_script, "script_slay_all_undead", ":agent_id"),
	(try_end),
    ]),
	
	("spawn_skeleton_horse", #SERVER: spawn a skeleton horse.
	...
	("slay_all_undead", #SERVER: slay all undead
	[(store_script_param_1, ":slayer_agent_id"),
	  (try_for_agents, ":cur_agent"),
		...
		(agent_deliver_damage_to_agent, ":slayer_agent_id", ":cur_agent", 10000000),
	  (try_end),	  
	]),
	
	("necromancer_kill_own_undead", #SERVER: necromancer slay undead horde
	[(store_script_param_1, ":slayer_agent_id"),
	...
	("spawn_skeleton_minion", #SERVER: spawn skeleton minion
	[(store_script_param_1, ":spawner_agent_id"),
	(try_begin),
	  (agent_get_player_id, ":spawner_player_id", ":spawner_agent_id"),
	  (store_add, ":test", "$g_zombie_count", 1),
	  (neq, ":test", zombie_max_count),
	  (val_add, "$g_zombie_count", 1),
	  (agent_get_position, pos1, ":spawner_agent_id"),
      (position_move_x, pos1, 50),
      (position_set_z_to_ground_level, pos1),
      (set_spawn_position, pos1),
	  ...
	  (try_begin),
			(gt, ":rand", 50),
			(spawn_agent, "trp_skeleton_archer"),
	  (else_try),
			(spawn_agent, "trp_skeleton_berserker"),
	  (try_end),
	...
	("resset_zombie_relations", #SERVER: recalculate zombie friends and enemies. this uses a state machine from slot_player_necromancer_zombie_state
	[
	...
	("aoe_wiz_damage", #SERVER: AOE damage from wizard staff
	...
	(try_for_agents, ":other_agent"),
		...
		(try_begin),
			(gt, ":test", 1),
			(agent_set_hit_points, ":other_agent", ":test"),
			(particle_system_burst,"psys_fireplace_fire_small", pos2, 15),
		(else_try),
			(agent_deliver_damage_to_agent,":attacker_agent", ":other_agent", ":damage"),
		(try_end),
	(try_end),
	
	]),
	
		("spawn_rock_golem", #SERVER: spawn rock golem
	[(store_script_param_1, ":spawner_agent_id"),
	(try_begin),
	  (agent_get_player_id, ":spawner_player_id", ":spawner_agent_id"),
	  (store_add, ":test", "$g_golem_count", 1),
	  (neq, ":test", golem_max_count),
	  (val_add, "$g_golem_count", 1),
	  (agent_get_position, pos1, ":spawner_agent_id"),
      (position_move_x, pos1, 50),
      (position_set_z_to_ground_level, pos1),
      (set_spawn_position, pos1),
	  (spawn_agent, "trp_rock_golem"),
	...
	("aoe_necro_damage", #SERVER: AOE damage from necro staff
	[(store_script_param, ":attacker_agent", 1),
	(agent_get_position, pos0, ":attacker_agent"),
	(agent_get_player_id, ":attacker_player", ":attacker_agent"),
	(player_get_slot, ":attacker_fac", ":attacker_player", slot_player_faction_id),
	...
	("transform_player_into_zombie", #SERVER: transform a player into a zombie after drinking funny stuff or dying from zombie plague RAMARAUNT ADD
	[(store_script_param, ":dead_agent_id",1),
	(store_script_param, ":should_it_be_in_place", 2),
	(store_script_param, ":necromancer_player_id", 3),
	(store_script_param, ":spawned", 4),
	(try_begin),
	  (store_add, ":test", "$g_zombie_count", 1),
	  (neq, ":test", zombie_max_count),
	  (val_add, "$g_zombie_count", 1),
	  (try_begin),
		(eq, ":spawned", 1),
		(neq, ":necromancer_player_id", -1),
		(player_get_agent_id, ":necromancer_agent_id", ":necromancer_player_id"),
		(agent_get_position, pos1, ":necromancer_agent_id"),
	  (else_try),
		(eq, ":spawned", 0),
		(agent_get_position, pos1, ":dead_agent_id"),
	  (try_end),
	  (try_begin),
			(eq, ":should_it_be_in_place", 0),
			(position_move_x, pos1, 50),
			(position_set_z_to_ground_level, pos1),
      (try_end),
      (set_spawn_position, pos1),
	  (particle_system_burst,"psys_war_smoke_tall", pos1, 15),
		...
		(spawn_agent,":zombie"),
	  (try_end),
		(agent_set_slot, reg0, slot_agent_necromancer, ":necromancer_player_id"),
	...
	[
	(store_script_param, ":player_id", 1),
	(store_script_param, ":illness", 2), #1 = cold, 2 = flu, 3 = plague
	(player_get_agent_id, ":agent_id", ":player_id"),
	(agent_get_position, pos0, ":agent_id"),
	...
	#spreading of illness
		...
		(try_for_agents, ":other_agent_id"), # find players that are close enough
		  ...
		  (player_is_active, ":other_player_id"),
		  (assign, ":continue", 1),
		  (agent_get_item_slot, ":hat", ":other_agent_id", ek_head),
		  (try_begin),
		  ...
		  (try_end),
		  (eq, ":continue", 1),
		  (neq, ":hat", "itm_zombie_head"),
		  (neq, ":hat", "itm_yellow_zombie_head"),
		  (neq, ":hat", "itm_red_zombie_head"),
		  (neq, ":hat", "itm_black_zombie_head"),
		  (neq, ":hat", "itm_evil_helmet"),
		  (neq, ":hat", "itm_evil_helmet"),
		  (neq, ":hat", "itm_skull_helmet"),
		  (neq, ":hat", "itm_ape_head"),
		  (neq, ":hat", "itm_oni_head"),
		  (neq, ":hat", "itm_ape_head"),
		  (neq, ":hat", "itm_invisible_head"),
		  (neq, ":hat", "itm_black_helmet"),
		  (neq, ":hat", "itm_mush_head_a"),
		  (neq, ":hat", "itm_mush_head_b"),
		  (neq, ":hat", "itm_mush_head_c"),
		  (neq, ":hat", "itm_mush_head_d"),
		  (neq, ":hat", "itm_mush_head_e"),
		  (neq, ":hat", "itm_mush_head_f"),
		  (neq, ":hat", "itm_mush_head_g"),
		  (neq, ":hat", "itm_mush_head_h"),
		  (neq, ":hat", "itm_mush_head_i"),
		  (neq, ":hat", "itm_mush_head_j"),
		  (neq, ":hat", "itm_mush_head_k"),
		  (neq, ":hat", "itm_rock_head"),
		  (neq, ":hat", "itm_lizard_head"),
		  (neq, ":hat", "itm_cactus_head"),
		  (neq, ":hat", "itm_eyeball"),
		  (neq, ":hat", "itm_mush_head_a"),
		  (neq, ":hat", "itm_cool_dude"),
		  (neq, ":hat", "itm_queen_head"),
		  (neq, ":hat", "itm_pug_man"),
		  (neq, ":hat", "itm_aqua_man"),
		  (neq, ":hat", "itm_shadow_helmet"),
		  (neq, ":hat", "itm_spider_head"),
		  (neq, ":hat", "itm_termite_head_a"),
		  (neq, ":hat", "itm_termite_head_b"),
		   (neq, ":hat", "itm_fly_demon_head"),
		  (agent_get_position, pos2, ":other_agent_id"),
		  (position_move_z, pos2, 160),
		  (get_sq_distance_between_positions, ":sq_distance", pos1, pos2),
	...
	("cf_catch_cold", #SERVER: player catches a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	("cf_imbed_cold", #SERVER: player catches forcefully a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	
	(player_is_active, ":player_id"),
	(call_script, "script_reset_illnesses",":player_id"),
	#(player_get_agent_id, ":agent_id", ":player_id"),
	(player_set_slot, ":player_id", slot_player_cold_progression, 74), #its begining...
	(player_set_slot, ":player_id", slot_player_cold_direction, 1), #its going up
	...
	("cf_lose_cold", #SERVER: player loses a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	(player_set_slot, ":player_id", slot_player_cold_immunity_timer, 40), #imumne for 40 food ticks
	...
	("cf_catch_flu", #SERVER: player catches a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	("cf_imbed_flu", #SERVER: player catches forcefully a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	
	(player_is_active, ":player_id"),
	#(player_get_agent_id, ":agent_id", ":player_id"),
	(call_script, "script_reset_illnesses",":player_id"),
	(player_set_slot, ":player_id", slot_player_flu_progression, 74), #its begining...
	...
	("cf_lose_flu", #SERVER: player loses a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	(player_set_slot, ":player_id", slot_player_flu_immunity_timer, 40), #imumne for 40 food ticks
	...
	("cf_catch_plague", #SERVER: player catches a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	(else_try),
		...
		(player_get_slot, ":progression", ":player_id", slot_player_flu_progression), #overwrite it with flu
	...
	("cf_imbed_plague", #SERVER: player catches forcefully a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	
	(player_is_active, ":player_id"),
	#(player_get_agent_id, ":agent_id", ":player_id"),
	(call_script, "script_reset_illnesses",":player_id"),
	(player_set_slot, ":player_id", slot_player_plague_progression, 74), #its begining...
	...
	("cf_lose_plague", #SERVER: player loses a cold RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	(player_set_slot, ":player_id", slot_player_plague_immunity_timer, 40), #imumne for 40 food ticks
	...
	("cf_illness_lower_immunities", #SERVER: player loses some immunity to illnesses RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	("cf_progress_illnesses", #SERVER: player's illness progresses RAMARAUNT ADD
	[(store_script_param_1, ":player_id"),
	
	(player_is_active, ":player_id"),
	
	(try_begin),#randomly catch flu
		(store_random_in_range, ":rand", 0, 500), # 1 out of 500 chance every food tick
		(eq, ":rand", 100),
		(call_script, "script_cf_catch_flu", ":player_id"),	
	(else_try),#randomly catch cold
		(store_random_in_range, ":rand", 0, 200),
		(eq, ":rand", 100),
		(call_script, "script_cf_catch_cold", ":player_id"),
	(try_end),
	(player_get_slot, ":cold_direction", ":player_id", slot_player_cold_direction),
	(try_begin),
		...
		(else_try),
			...
			(try_begin),
				...
				(call_script, "script_cf_lose_cold", ":player_id"),
			(try_end),
		(try_end),
	...
	(else_try),
		...
		(else_try),
			...
			(try_begin),
				...
				(call_script, "script_cf_lose_flu", ":player_id"),
			(try_end),
		(try_end),
	...
	(else_try), #plague begin
		...
		(else_try),
			...
			(try_begin),
				...
				(call_script, "script_cf_lose_plague", ":player_id"),
			(try_end),
		(try_end),
	...
	("reset_illnesses", #server: respet illness variables (usually done after death). RAMARAUNT ADD
	[(store_script_param, ":player_id", 1),
	...
	(try_begin),
		...
		(player_set_slot, ":player_id", slot_player_zombie_infected, -1),
	(try_end),
  ...
  ("check_agent_health", # server: check for armor encumbrance, poison, and passive healing effects #RAMARAUNT ADD DRUNKENESS, HUNGER, ILLNESS
   [(store_script_param, ":agent_id", 1), # must be valid

   #resset iceballs (the melted!)
   	(try_for_prop_instances, ":ice_ball", "spr_pws_code_ice_stuck"),
		(prop_instance_get_position, pos1, ":ice_ball"),
		(neg|scene_prop_slot_eq, ":ice_ball", slot_scene_prop_state, scene_prop_state_hidden),
		(call_script, "script_remove_scene_prop", ":ice_ball"),
	(try_end),
	(assign, "$g_cur_iceball", 1),
    ...
    (try_begin),
	  ...
	  (player_is_active, ":player_id"),
	  (player_set_slot, ":player_id", slot_player_zombie_infected, -1),
	  (player_set_slot, ":player_id", slot_player_zombie_necromancer, -1),
	  (call_script, "script_resset_zombie_relations"),
      (agent_get_slot, ":food_amount", ":agent_id", slot_agent_food_amount),
	  (player_get_slot, ":cur_food_tick", ":player_id", slot_player_food_tick),
	  (player_get_slot, ":drunkeness", ":player_id", slot_player_drunkeness),
	  (try_begin),
		  (call_script, "script_cf_illness_lower_immunities", ":player_id"),
		  (call_script, "script_cf_progress_illnesses", ":player_id"),
	  (try_end),
	  (try_begin), #RAMARAUNT ADD HUNGER
		  (try_begin), #drunkeness makes you lose food faster
			  (ge, ":drunkeness", 80),
			  (assign, ":tick_amount", 2),
		  (else_try),
			  (ge, ":drunkeness", 60),
			  (assign, ":tick_amount", 3),
		  (else_try),
			  (ge, ":drunkeness", 40),
			  (assign, ":tick_amount", 4),
		  (else_try),
			  (assign, ":tick_amount", 5),
		  (try_end),
		  (ge, ":cur_food_tick", ":tick_amount"),
		  (player_set_slot, ":player_id", slot_player_food_tick, 0),
		  (val_sub, ":food_amount", 2),
		  (agent_set_slot, ":agent_id", slot_agent_food_amount, ":food_amount"),
		  (multiplayer_send_3_int_to_player, ":player_id", server_event_agent_set_slot, ":agent_id", slot_agent_food_amount, ":food_amount"),
		(else_try),
			(val_add, ":cur_food_tick", 1),
			(player_set_slot, ":player_id", slot_player_food_tick, ":cur_food_tick"),
		(try_end),	
		(try_begin),
			(le, ":food_amount", 1),
			(store_agent_hit_points, ":hit_points", ":agent_id", 0),
			(val_sub, ":hit_points", 3),
			(agent_set_hit_points, ":agent_id", ":hit_points", 0),
		(try_end),
		(try_begin), #drunkeness add
			(ge, ":drunkeness", 1),
			(val_sub, ":drunkeness", 1),
			(try_begin), #vomiting roll
				(ge, ":drunkeness", 50),
				(store_mod, ":mod", ":drunkeness", 3),
				(eq, ":mod", 0),
			...
			(try_begin), #client updates
				(this_or_next|eq, ":drunkeness", 89),
				(this_or_next|eq, ":drunkeness", 74),
				(this_or_next|eq, ":drunkeness", 59),
				(this_or_next|eq, ":drunkeness", 29),
				(eq, ":drunkeness", 0),
				(multiplayer_send_int_to_player, ":player_id", server_event_drunk_update_client, ":drunkeness"),
			(try_end),
			(player_set_slot, ":player_id", slot_player_drunkeness, ":drunkeness"),
		(try_end),
	  (try_end),
   ...
   [(store_script_param, ":dead_agent_id", 1),
    ...
    (try_begin),
	  ...
	  (try_begin),
		...
		(this_or_next|eq, ":troop_id", "trp_tank_zombie"),
		(this_or_next|eq, ":troop_id", "trp_fast_zombie"),
		(this_or_next|eq, ":troop_id", "trp_rotting_zombie"),
		(this_or_next|eq, ":troop_id", "trp_skeleton_archer"),
		(this_or_next|eq, ":troop_id", "trp_skeleton_berserker"),
		(this_or_next|eq, ":troop_id", "trp_rock_golem"),
		(eq, ":troop_id", "trp_zombie"), #RAMARAUNT ADD
