...
####################################################################################################################
  ...
  ["traveler","Traveler","a traveler",tf_guarantee_all,0,0,"fac_commoners",
   ...
   str_14|agi_12|pw_attr,wpex(80,65,80,10,20,80),knows_pw|knows_ironflesh_3|knows_power_strike_4|knows_athletics_3|knows_riding_1|knows_looting_5,default_face_1,default_face_2],
   ["brigand","Brigand","a brigand",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_knife","itm_blunt_falchion"],
   str_12|agi_12|pw_attr,wpex(70,40,70,100,60,70),knows_pw|knows_ironflesh_2|knows_power_strike_2|knows_power_draw_3|knows_athletics_3|knows_riding_1|knows_looting_4|knows_sailing_4,default_face_1,default_face_2],
   ...
   str_30|agi_30|pw_attr,wpex(300,300,300,300,300,300),knows_pw|knows_ironflesh_10|knows_power_strike_10|knows_power_draw_10|knows_power_throw_10|knows_shield_10|knows_athletics_10|knows_riding_10|knows_engineer_10|knows_wound_treatment_10|knows_looting_10|knows_labouring_10|knows_sailing_10|knows_tailoring_10|knows_herding_10,default_face_1,default_face_2],
    ...
    ["samauri","Samurai","a samurai",tf_guarantee_all,0,0,"fac_commoners",
    ["itm_hakama_old","itm_old_tabi","itm_old_tanto"],
    str_15|agi_15|pw_attr,wpex(110,125,110,20,60,40),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_power_throw_5|knows_shield_2|knows_athletics_5|knows_riding_2,default_face_1,default_face_2],
    ["levy","Levy","a levy",tf_guarantee_all,0,0,"fac_commoners",
    ["itm_old_gekokujo_kimono_2_1","itm_old_tanto"],
    str_10|agi_9|pw_attr,wpex(70,40,70,10,40,50),knows_pw|knows_ironflesh_2|knows_power_strike_2|knows_power_throw_3|knows_athletics_2|knows_riding_1|knows_labouring_1|knows_herding_2,default_face_1,default_face_2],
   ["retainer","Retainer","a retainer",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_gekokujo_kimono_1_1","itm_old_tanto","itm_old_tabi"],
   str_15|agi_14|pw_attr,wpex(100,100,130,10,45,80),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_power_throw_2|knows_shield_1|knows_athletics_5|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
   ["ninja","Ninja","a ninja",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_tanto", "itm_old_gekokujo_kimono_1_1", "itm_old_gekokujo_ninja_headwrap"],
   str_12|agi_12|pw_attr,wpex(70,70,150,150,150,150),knows_pw|knows_ironflesh_2|knows_power_strike_2|knows_power_draw_4|knows_power_throw_6|knows_athletics_8|knows_riding_2|knows_looting_6,default_face_1,default_face_2],
   ["thief","Thief","a thief",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_knife"],
   str_12|agi_12|pw_attr,wpex(70,40,70,100,60,70),knows_pw|knows_ironflesh_2|knows_power_strike_2|knows_power_draw_3|knows_power_throw_4|knows_athletics_3|knows_riding_1|knows_looting_6|knows_sailing_4,default_face_1,default_face_2],
   ["thug","Thug","a thug",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_knife","itm_blunt_sickle"],
   str_12|agi_12|pw_attr,wpex(70,40,70,100,60,70),knows_pw|knows_ironflesh_2|knows_power_strike_2|knows_power_throw_2|knows_power_draw_3|knows_athletics_3|knows_riding_1|knows_looting_4|knows_sailing_4,default_face_1,default_face_2],
   ["horse_archer","Horse Archer","a horse archer",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ["itm_tattered_headcloth","itm_tattered_wrapping_boots","itm_bent_arrows", "itm_crude_bow"],
   str_14|agi_14|pw_attr,wpex(90,60,120,10,30,80),knows_pw|knows_ironflesh_3|knows_power_strike_3|knows_horse_archery_6|knows_power_draw_5|knows_power_throw_2|knows_athletics_1|knows_riding_6,default_face_1,default_face_2],
   ["samurai_horse_archer","Samurai Horse Archer","a samurai horse archer",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ["itm_tattered_headcloth","itm_old_gekokujo_kimono_2_1","itm_bent_lance","itm_bent_arrows","itm_crude_bow"],
   str_14|agi_14|pw_attr,wpex(90,60,120,10,30,80),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_horse_archery_6|knows_power_draw_6|knows_power_throw_3|knows_athletics_2|knows_riding_6,default_face_1,default_face_2],
   ["elephant_master","Elephant Master","an elephant master",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ["itm_tattered_headcloth","itm_old_gekokujo_kimono_2_1","itm_bent_lance","itm_bent_arrows","itm_crude_bow"],
   str_14|agi_14|pw_attr,wpex(90,60,120,100,30,80),knows_pw|knows_ironflesh_5|knows_power_strike_2|knows_horse_archery_4|knows_power_draw_4|knows_power_throw_2|knows_athletics_2|knows_riding_8,default_face_1,default_face_2],

   ["bow_master","Bow Master","a bow master",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_tattered_headcloth","itm_old_gekokujo_kimono_2_1","itm_tattered_wrapping_boots","itm_crude_bow","itm_bent_arrows"],
   str_14|agi_14|pw_attr,wpex(90,60,70,150,50,50),knows_pw|knows_ironflesh_4|knows_power_strike_2|knows_power_throw_2|knows_horse_archery_2|knows_power_draw_4|knows_athletics_4|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
   ["hunter","Hunter","a hunter",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_ragged_woolen_cap","itm_old_gekokujo_kimono_2_1","itm_crude_bow","itm_bent_arrows"],
   str_9|agi_9|pw_attr,wpex(60,35,50,100,100,50),knows_pw|knows_ironflesh_1|knows_power_throw_2|knows_power_strike_1|knows_power_draw_2|knows_athletics_1|knows_riding_1|knows_labouring_1|knows_herding_3,default_face_1,default_face_2],
   ["cavalry","Cavalry","a cavalry",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ["itm_tattered_headcloth","itm_old_gekokujo_kimono_2_1","itm_tattered_wrapping_boots","itm_bent_lance"],
   str_14|agi_14|pw_attr,wpex(90,60,120,10,30,80),knows_pw|knows_ironflesh_3|knows_power_throw_4|knows_power_strike_3|knows_power_throw_2|knows_athletics_1|knows_riding_6,default_face_1,default_face_2],
   ["outrider","Outrider","an outrider",tf_mounted|tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_old_gekokujo_kimono_2_1","itm_old_hide_boots","itm_old_tanto"],
   str_15|agi_15|pw_attr,wpex(105,120,110,20,50,30),knows_pw|knows_ironflesh_4|knows_power_throw_2|knows_power_strike_4|knows_shield_1|knows_athletics_2|knows_riding_4,default_face_1,default_face_2],
   ["funanori","Funanori","a funanori",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_old_gekokujo_kimono_2_1","itm_old_hide_boots","itm_old_tanto"],
   str_15|agi_15|pw_attr,wpex(110,125,110,20,60,40),knows_pw|knows_ironflesh_5|knows_power_strike_4|knows_power_throw_2|knows_shield_2|knows_athletics_5|knows_riding_2,default_face_1,default_face_2],
   ["shepherd","Shepherd","a sheperd",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_gekokujo_kimono_2_1","itm_tattered_wrapping_boots","itm_old_knife"],
   str_10|agi_14|pw_attr,wpex(50,35,40,0,10,40),knows_pw|knows_power_strike_1|knows_athletics_5|knows_power_throw_2|knows_labouring_2|knows_herding_5,default_face_1,default_face_2],
   ["explorer","Explorer","an explorer",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_coarse_tunic","itm_old_hide_boots","itm_tattered_wrapping_boots","itm_old_knife"],
   str_10|agi_13|pw_attr,wpex(60,40,50,10,20,60),knows_pw|knows_power_throw_3|knows_ironflesh_1|knows_power_strike_2|knows_athletics_5|knows_sailing_7|knows_riding_3|knows_labouring_1|knows_herding_1|knows_tailoring_2,default_face_1,default_face_2],
   ["physician","Physician","a physician",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_gekokujo_kimono_1_1","itm_ripped_woolen_hose"],
   str_10|agi_10|pw_attr,wpex(70,40,50,10,20,30),knows_pw|knows_athletics_2|knows_power_strike_2|knows_wound_treatment_5|knows_riding_2,default_face_1,default_face_2],
   ["blacksmith","Blacksmith","a blacksmith",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_gekokujo_kimono_1_1","itm_ragged_leather_apron","itm_old_hide_boots","itm_old_tanto"],
   str_12|agi_12|pw_attr,wpex(100,55,70,30,70,50),knows_pw|knows_power_throw_2|knows_ironflesh_3|knows_power_strike_3|knows_athletics_2|knows_engineer_7|knows_riding_2|knows_looting_2|knows_sailing_4,default_face_1,default_face_2],
   ["architect","Architect","an architect",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_gekokujo_kimono_2_1","itm_old_gekokujo_kimono_1_1","itm_ragged_leather_apron","itm_old_hide_boots","itm_tattered_wrapping_boots","itm_old_knife"],
   str_10|agi_12|pw_attr,wpex(90,50,60,30,65,50),knows_pw|knows_ironflesh_2|knows_power_throw_2|knows_power_strike_2|knows_athletics_2|knows_engineer_5|knows_riding_2|knows_looting_1|knows_sailing_4,default_face_1,default_face_2],
   ["sharpshooter","Sharpshooter","a sharpshooter",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_old_gekokujo_kimono_1_1","itm_ragged_woolen_cap","itm_tattered_wrapping_boots","itm_flimsy_crossbow","itm_crude_bolts"],
   str_14|agi_14|pw_attr,wpex(90,60,60,50,150,50),knows_pw|knows_power_throw_2|knows_ironflesh_3|knows_power_strike_3|knows_athletics_4|knows_riding_2|knows_sailing_3,default_face_1,default_face_2],
   ["tailor","Tailor","a tailor",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_stained_felt_hat_b","itm_old_coarse_tunic"],
   str_8|agi_8|pw_attr,wpex(50,30,30,20,20,20),knows_pw|knows_power_throw_1|knows_power_strike_1|knows_riding_1|knows_engineer_2|knows_labouring_1|knows_tailoring_3,default_face_1,default_face_2],
   ["farmer","Farmer","a farmer",tf_guarantee_all,0,0,"fac_commoners",
   ["itm_ragged_shirt","itm_hatchet","itm_blunt_sickle","itm_old_knife"],
   str_5|agi_5|pw_attr,wpex(30,30,30,0,0,50),knows_pw|knows_power_throw_1|knows_power_strike_1|knows_labouring_5|knows_engineer_1|knows_tailoring_1|knows_herding_3|knows_riding_1,default_face_1,default_face_2],
   
  ["zombie","Slow Zombie","a slow zombie",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_zombie_head","itm_zombie_hands","itm_zombie_body","itm_zombie_feet", "itm_zombie_sword"],
   str_10|agi_10|pw_attr,wpex(75,75,75,75,75,75),knows_pw|knows_ironflesh_2|knows_power_strike_1|knows_athletics_1,default_face_1,default_face_2],
   
   ["tank_zombie","Tough Zombie","a tough zombie",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_red_zombie_head","itm_red_zombie_hands","itm_red_zombie_body","itm_red_zombie_feet", "itm_zombie_sword"],
   str_10|agi_10|pw_attr,wpex(75,75,75,75,75,75),knows_pw|knows_ironflesh_10|knows_power_strike_4|knows_athletics_1,default_face_1,default_face_2],
   
   ["fast_zombie","Fast Zombie","a fast zombie",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_yellow_zombie_head","itm_yellow_zombie_hands","itm_yellow_zombie_body","itm_yellow_zombie_feet", "itm_zombie_sword"],
   str_10|agi_10|pw_attr,wpex(200,200,200,200,200,200),knows_pw|knows_ironflesh_1|knows_power_strike_2|knows_athletics_9,default_face_1,default_face_2],
   
   ["rotting_zombie","Rotting Zombie","a rotting zombie",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_black_zombie_head","itm_black_zombie_hands","itm_black_zombie_body","itm_black_zombie_feet", "itm_zombie_sword"],
   str_10|agi_10|pw_attr,wpex(150,150,150,150,150,150),knows_pw|knows_ironflesh_2|knows_power_strike_6|knows_athletics_3,default_face_1,default_face_2],
   
   ["skeleton_archer","Skeleton Archer","a skeleton archer",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_skull_helmet","itm_skeleton_hands","itm_skeleton_body","itm_skeleton_feet", "itm_skeleton_dagger", "itm_skeleton_bow", "itm_skeleton_arrows"],
   str_12|agi_12|pw_attr,wpex(150,150,150,150,150,150),knows_pw|knows_ironflesh_2|knows_power_strike_1|knows_power_draw_6|knows_athletics_3,default_face_1,default_face_2],
   
   ["skeleton_berserker","Skeleton Berserker","a skeleton berserker",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_skull_helmet","itm_skeleton_hands","itm_skeleton_armor","itm_skeleton_feet", "itm_skeleton_cleaver"],
   str_12|agi_12|pw_attr,wpex(150,150,150,150,150,150),knows_pw|knows_ironflesh_8|knows_power_strike_6|knows_athletics_2,default_face_1,default_face_2],
   
   ["oni","Oni Deathweaver","an oni deathweaver",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_oni_head","itm_oni_hands","itm_oni_feet","itm_oni_armor", "itm_fireball", "itm_oni_axe"],
   str_12|agi_12|pw_attr,wpex(150,150,150,150,150,150),knows_pw|knows_ironflesh_8|knows_power_throw_6|knows_power_strike_6|knows_athletics_2,default_face_1,default_face_2],
   
   ["rock_golem","Ice Golem","an ice golem",tf_male|tf_guarantee_all,0,0,"fac_zombies",
   ["itm_rock_head","itm_invisible_hand","itm_rock_feet","itm_rock_body", "itm_rockball_golem", "itm_rock_sword"],
   str_12|agi_12|pw_attr,wpex(150,150,150,150,150,150),knows_pw|knows_ironflesh_8|knows_power_throw_6|knows_power_strike_6|knows_athletics_2,default_face_1,default_face_2],
   #RAMARAUNT END
