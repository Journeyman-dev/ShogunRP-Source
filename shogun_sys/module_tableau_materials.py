...
tableaus = [
  ...
  ("samurai_heraldic_flag", 0, "sample_samurai_nobori_heraldic", 1024, 1024, 0, 0, 0, 0,tableau_armor_banner("mesh_tableau_mesh_samurai_heraldic_flag", banner_xyz=(50,-85,-22), banner_scale = 40)),
  
  ("banner_spear", 0, "sample_samurai_weapons", 1024, 1024, 0, 0, 0, 0,tableau_armor_color("mesh_tableau_mesh_banner_spear")),
