...
server_event_lockpick                           = 29 #RAMARAUNT ADD 0 = fail 1 = success
server_event_drunk_drink                        = 30 #RAMARAUNT ADD
server_event_drunk_update_client                = 31 #RAMARAUNT ADD
server_event_player_has_vomited                 = 32 #RAMARAUNT ADD
server_event_player_has_coughed                 = 33 #RAMARAUNT ADD
server_event_illness_update                     = 34 #RAMARAUNT ADD
server_event_died_from_illness                  = 35 #RAMARAUNT ADD
server_event_necromancer_message                = 36 #RAMARAUNT ADD


# Add new events here: above if sent from the server, below if from clients.


client_event_local_twenty                       = 94 #RAMARAUNT ADD
